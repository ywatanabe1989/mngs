#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Example: Legend positioning and CSV export improvements in MNGS
# Timestamp: "2025-06-09 21:57:00 (ywatanabe)"

"""
This example demonstrates the improved legend positioning options and
enhanced CSV export functionality for seaborn plots in MNGS.
...
fig1, ax1 = mngs.plt.subplots(figsize=(8, 6))
ax1.sns_lineplot(
    data=data, 
    x='time', 
    y='measurement', 
...
mngs.io.save(df_export, 'seaborn_lineplot_data.csv')
mngs.io.save(fig1, 'treatment_comparison.png')

# Example 2: Multiple plot types with outer legend
print("\n\nExample 2: Multiple plot types with outer legend")
fig2, ax2 = mngs.plt.subplots(figsize=(8, 6))
...
mngs.io.save(df_box_export, 'boxplot_data.csv')
mngs.io.save(fig3, 'boxplot_comparison.png')
...
fig4, axes4 = mngs.plt.subplots(1, 3, figsize=(15, 4))
...
mngs.io.save(fig4, 'legend_position_examples.png')
