...
# Author: MNGS Framework
# Description: Run all MNGS examples and verify they complete successfully

echo "=========================================="
echo "Running all MNGS examples"
echo "=========================================="
...
EXAMPLES=($(find "$SCRIPT_DIR/mngs" -name "*.py" -type f | sort))
...
echo -e "\n${YELLOW}Running: mngs_framework.py${NC}"
run_example "$SCRIPT_DIR/mngs_framework.py"
