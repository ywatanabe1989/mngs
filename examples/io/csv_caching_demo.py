...
def test_csv_caching():
    ...
    print("MNGS CSV Caching Demonstration")
    print("=" * 50)
    ...
    mngs.io.save(df, "test_data.csv", index=False)
    ...
    for size in SIZES:
        ...
        # First save
        start = time.perf_counter()
        mngs.io.save(large_df, f"large_data_{size}.csv", index=False)
...
"""
    ...
    mngs.io.save(report, "performance_report.txt")
    print(report)
