...
Functionalities:
  ...
  - Uses mngs classifiers and utilities
...
Dependencies:
  - scripts: None
  - packages: numpy, pandas, matplotlib, sklearn, mngs
...
def train_classifiers(X_train, X_val, y_train, y_val):
    ...
    classifiers = {
        ...
        "SVM": mngs.ai.sklearn.SVC(kernel="rbf", probability=True, random_state=42),
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="MNGS Machine Learning Workflow Example"
    )
