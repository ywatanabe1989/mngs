...
__FILE__ = "./examples/mngs/gen/experiment_workflow.py"
__DIR__ = os.path.dirname(__FILE__)
# ----------------------------------------

"""
Functionalities:
  - Sets up reproducible experiments with mngs.gen.start
  - Manages automatic logging and output directories
  - Handles random seed management for reproducibility
  - Demonstrates proper cleanup with mngs.gen.close
...
def main(args):
    ...
    # 2. Save raw data
    print("\n2. Saving raw data...")
    mngs.io.save({"X": X, "y": y, "true_weights": true_weights}, "raw_data.npz")
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Complete experiment workflow with mngs.gen"
    )
