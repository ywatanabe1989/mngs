#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Time-stamp: "2025-05-31 12:00:00 (ywatanabe)"
# File: ./mngs_repo/examples/mngs/db/database_operations.py

__FILE__ = "./examples/mngs/db/database_operations.py"

"""
Comprehensive examples of MNGS database operations.

This module demonstrates the key features of mngs.db:
1. Basic SQLite database operations
2. Table creation and management
3. CRUD operations (Create, Read, Update, Delete)
4. Batch operations for performance
5. NumPy array storage as BLOBs
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        try:
            with db.transaction():
                ...
                # Check balance
                db.execute("SELECT balance FROM accounts WHERE account_number = ?", ("ACC001",))
...
def example_import_export():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        employees_df = pd.DataFrame({
            ...
            "hire_date": ["2020-01-15", "2019-06-01", "2021-03-20", "2020-11-10", "2022-02-01"]
        })
...
def example_database_maintenance():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        logs = [
            {"level": "INFO", "message": f"Log entry {i}"}
            for i in range(1000)
        ]
        ...
        # Verify backup
        backup_db = mngs.db.SQLite3(backup_path)
...
def main(args):
    ...
    print("=" * 60)
    print("MNGS Database Operations Examples")
    print("=" * 60)
