...
"""
Basic example of using MNGS Scholar for scientific literature search.
...
def demo_environment_setup():
    ...
    # You can set MNGS_SCHOLAR_DIR environment variable to change it
    print("\nTo change the default directory, set:")
    print("export MNGS_SCHOLAR_DIR='~/my_papers'")


def main():
    """Run all demonstrations."""
    print("MNGS Scholar - Scientific Literature Search Demo")
    print("=" * 50)
