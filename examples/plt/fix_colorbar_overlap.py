#!/usr/bin/env python3
"""Demonstrate how to fix colorbar overlap issues with mngs.plt"""
...
plt.tight_layout()
mngs.io.save(fig1, "./colorbar_fix_example1.png")
...
mngs.io.save(fig2, "./colorbar_fix_example2.png")
...
from mngs.plt.utils import add_shared_colorbar
cbar = add_shared_colorbar(fig3, axes3, images[0], location='right')
cbar.set_label('Shared Scale')

mngs.io.save(fig3, "./colorbar_fix_example3.png")
...
mngs.io.save(fig4, "./colorbar_fix_example4_modulation_index_style.png")
