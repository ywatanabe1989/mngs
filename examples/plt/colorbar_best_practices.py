#!/usr/bin/env python3
"""Best practices for using colorbars with mngs.plt"""
...
plt.tight_layout()
mngs.io.save(fig1, "./colorbar_example1_default.png")
...
mngs.io.save(fig2, "./colorbar_example2_adjusted.png")
...
mngs.io.save(fig3, "./colorbar_example3_shared.png")
...
mngs.io.save(fig4, "./colorbar_example4_manual.png")
