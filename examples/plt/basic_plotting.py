...
"""
Functionalities:
  - Demonstrates basic mngs.plt functionality
...
def create_plots():
    ...
    mngs.io.save(fig, "simple_line_plot.png")
    ...
    mngs.io.save(fig, "scatter_plot.png")
    ...
    plt.tight_layout()
    mngs.io.save(fig, "subplots_example.png")
    
    # 4. Using MNGS color scheme
    print("4. Creating plot with MNGS colors...")
    fig, ax = plt.subplots(figsize=(8, 6))
    ...
    ax.set_title('MNGS Color Scheme Example')
    ax.legend()
    ax.grid(True, alpha=0.3)
    mngs.io.save(fig, "mngs_colors.png")
