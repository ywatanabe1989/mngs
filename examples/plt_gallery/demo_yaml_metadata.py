...
try:
    import mngs
    print("✅ Using mngs from source")
except ImportError:
    print("❌ Could not import mngs - using matplotlib directly for demo")
    # Fallback demo without mngs
    exit(1)
...
def demo_single_panel_metadata():
    ...
    try:
        mngs.io.save(fig, f'{output_file}.png')
        ...
        from mngs.plt.ax._style._set_meta import export_metadata_yaml
...
def main():
    ...
    print("🚀 MNGS Scientific Metadata System Demo")
    print("="*50)
