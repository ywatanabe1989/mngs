#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Generate example plots for mngs.plt documentation."""
...
# Output directory
OUTPUT_DIR = "/data/gpfs/projects/punim2354/ywatanabe/.claude-worktree/mngs_repo/examples/plt_gallery/figures"
...
def generate_basic_plots():
    ...
    ax.legend()
    mngs.io.save(fig, os.path.join(OUTPUT_DIR, "01_basic_line_plot.png"))
    plt.close()
    ...
    mngs.io.save(fig, os.path.join(OUTPUT_DIR, "02_scatter_plot.png"))
    plt.close()
    ...
    mngs.io.save(fig, os.path.join(OUTPUT_DIR, "03_bar_plot.png"))
    plt.close()
    ...
    mngs.io.save(fig, os.path.join(OUTPUT_DIR, "04_histogram.png"))
    plt.close()
    ...
    mngs.io.save(fig, os.path.join(OUTPUT_DIR, "05_boxplot.png"))
    plt.close()
...
def generate_advanced_plots():
    ...
    mngs.io.save(fig, os.path.join(OUTPUT_DIR, "06_heatmap.png"))
    plt.close()
    ...
    mngs.io.save(fig, os.path.join(OUTPUT_DIR, "07_mean_std_plot.png"))
    plt.close()
    ...
    mngs.io.save(fig, os.path.join(OUTPUT_DIR, "08_violin_plot.png"))
    plt.close()
    ...
    ax.legend()
    mngs.io.save(fig, os.path.join(OUTPUT_DIR, "09_fill_between.png"))
    plt.close()
    ...
    mngs.io.save(fig, os.path.join(OUTPUT_DIR, "10_ecdf_plot.png"))
    plt.close()
...
def generate_subplot_examples():
    ...
    mngs.io.save(fig, os.path.join(OUTPUT_DIR, "11_multiple_subplots.png"))
    plt.close()
    
    # 12. Shared axes
    fig, axes = mngs.plt.subplots(3, 1, figsize=(10, 8), sharex=True)
    ...
    mngs.io.save(fig, os.path.join(OUTPUT_DIR, "12_shared_axes.png"))
    plt.close()
...
def generate_seaborn_examples():
    ...
    mngs.io.save(fig, os.path.join(OUTPUT_DIR, "13_seaborn_barplot.png"))
    plt.close()
    ...
    mngs.io.save(fig, os.path.join(OUTPUT_DIR, "14_seaborn_violinplot.png"))
    plt.close()
...
def generate_color_examples():
    ...
    colors = mngs.plt.color.get_colors_from_cmap(8, cmap='viridis')
    ...
    ax.set_xticks(x)
    mngs.io.save(fig, os.path.join(OUTPUT_DIR, "15_colormap_example.png"))
    plt.close()
    ...
    interpolated = mngs.plt.color.interpolate(start_colors, 20)
    ...
    ax.set_aspect('equal')
    mngs.io.save(fig, os.path.join(OUTPUT_DIR, "16_color_interpolation.png"))
    plt.close()
...
def generate_special_plots():
    ...
    mngs.io.save(fig, os.path.join(OUTPUT_DIR, "17_raster_plot.png"))
    plt.close()
    ...
    mngs.io.save(fig, os.path.join(OUTPUT_DIR, "18_confusion_matrix.png"))
    plt.close()
    ...
    ax.legend()
    mngs.io.save(fig, os.path.join(OUTPUT_DIR, "19_fill_vertical.png"))
    plt.close()
    ...
    ax.grid(True, alpha=0.3)
    mngs.io.save(fig, os.path.join(OUTPUT_DIR, "20_mean_confidence_interval.png"))
    plt.close()
...
def generate_style_examples():
    ...
    mngs.io.save(fig, os.path.join(OUTPUT_DIR, "21_custom_style.png"))
    plt.close()
    ...
    mngs.io.save(fig, os.path.join(OUTPUT_DIR, "22_scientific_notation.png"))
    plt.close()
...
def generate_export_example():
    ...
    mngs.io.save(fig, os.path.join(OUTPUT_DIR, "23_export_example.png"))
...
def main():
    ...
    print(f"Generating mngs.plt examples in {OUTPUT_DIR}")
