#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Generate simple example plots for mngs.plt documentation."""
...
def generate_examples():
    ...
    mngs.io.save(fig, os.path.join(OUTPUT_DIR, "04_multiple_subplots.png"))
    plt.close()
    ...
    mngs.io.save(fig, os.path.join(OUTPUT_DIR, "05_export_example.png"))
