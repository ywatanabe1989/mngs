...
Successfully implemented the `mngs.scholar` module with:
...
- Detailed example script: `examples/mngs/scholar/basic_search_example.py`
- Unit tests: `tests/mngs/scholar/test_scholar_basic.py`
...
- `src/mngs/stats/tests/_corr_test.py`
