# MNGS Test Coverage Implementation Plan
...
# File: ./mngs_repo/tests/mngs/module/test__function.py
...
class TestFunctionName:
    ...
    def test_basic_functionality(self):
        ...
        from mngs.module._function import function_name
...
- [ ] Tests follow MNGS testing guidelines
