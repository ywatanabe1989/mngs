...
The project has excellent test coverage but lacks practical examples showing users how to use MNGS effectively.
...
- Follow the MNGS template strictly per CLAUDE.md
- Include real-world use cases
- Add output examples

**Modules needing examples:**
- `mngs.io` - File I/O operations
- `mngs.plt` - Plotting capabilities
...
## Immediate Next Step
Create comprehensive examples for the mngs.io module to demonstrate file I/O capabilities, including the newly fixed CSV caching functionality.