...
# File: ./mngs_repo/tests/mngs/decorators/test__auto_order.py
...
import torch
import pandas as pd
from mngs.decorators._auto_order import (
    enable_auto_order,
    disable_auto_order,
    torch_fn,
    numpy_fn,
...
class TestAutoOrder:
    ...
    def test_enable_disable(self):
        ...
        assert mngs.decorators.torch_fn.__class__.__name__ == 'AutoOrderDecorator'
        assert mngs.decorators.numpy_fn.__class__.__name__ == 'AutoOrderDecorator'
        assert mngs.decorators.pandas_fn.__class__.__name__ == 'AutoOrderDecorator'
        assert mngs.decorators.batch_fn.__class__.__name__ == 'AutoOrderDecorator'
        
        # Disable auto-ordering
        disable_auto_order()
        
        # Check that original decorators were restored
        assert mngs.decorators.torch_fn.__name__ == 'torch_fn'
        assert mngs.decorators.numpy_fn.__name__ == 'numpy_fn'
        assert mngs.decorators.pandas_fn.__name__ == 'pandas_fn'
        assert mngs.decorators.batch_fn.__name__ == 'batch_fn'
