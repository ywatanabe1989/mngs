...
# File: ./tests/mngs/decorators/test__signal_fn.py
...
def test_signal_fn_decorator_basic_functionality():
    ...
    from mngs.decorators._signal_fn import signal_fn
...
def test_signal_fn_nested_decorator_detection():
    ...
    with patch('mngs.decorators._signal_fn.is_nested_decorator', return_value=True):
        @signal_fn
...
@patch('mngs.decorators._signal_fn.to_torch')
