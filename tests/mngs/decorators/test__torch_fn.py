...
__FILE__ = "./tests/mngs/decorators/test__torch_fn.py"
...
def test_torch_fn_nested_decorator(test_data):
    ...
    with patch("mngs.decorators._torch_fn.is_nested_decorator", return_value=True):
...
def test_torch_fn_original_bug_case():
    ...
    try:
        result = mngs.stats.desc.describe(tensor_input)
