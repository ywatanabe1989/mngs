...
# File: ./tests/mngs/decorators/test__combined.py
...
def test_combined_torch_batch_fn_exists():
    ...
    from mngs.decorators._combined import torch_batch_fn
...
def test_combined_numpy_batch_fn_exists():
    ...
    from mngs.decorators._combined import numpy_batch_fn
...
def test_combined_pandas_batch_fn_exists():
    ...
    from mngs.decorators._combined import pandas_batch_fn
    
    assert pandas_batch_fn is not None
    assert callable(pandas_batch_fn)


@mock.patch('mngs.decorators._combined.torch_fn')
@mock.patch('mngs.decorators._combined.batch_fn')
...
@mock.patch('mngs.decorators._combined.numpy_fn')
@mock.patch('mngs.decorators._combined.batch_fn')
...
@mock.patch('mngs.decorators._combined.pandas_fn')
@mock.patch('mngs.decorators._combined.batch_fn')
...
def test_combined_aliases_exist():
    ...
    from mngs.decorators._combined import (
...
def test_combined_all_exports():
    ...
    from mngs.decorators._combined import __all__
...
def test_combined_imports_work():
    ...
    from mngs.decorators._combined import numpy_batch_fn
    from mngs.decorators._combined import pandas_batch_fn
    from mngs.decorators._combined import batch_torch_fn
    from mngs.decorators._combined import batch_numpy_fn
    from mngs.decorators._combined import batch_pandas_fn
...
@mock.patch('mngs.decorators._combined.torch_fn', side_effect=lambda x: x)
@mock.patch('mngs.decorators._combined.batch_fn', side_effect=lambda x: x)
...
@mock.patch('mngs.decorators._combined.numpy_fn', side_effect=lambda x: x)
@mock.patch('mngs.decorators._combined.batch_fn', side_effect=lambda x: x)
...
@mock.patch('mngs.decorators._combined.pandas_fn', side_effect=lambda x: x)
@mock.patch('mngs.decorators._combined.batch_fn', side_effect=lambda x: x)
