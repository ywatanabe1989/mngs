#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Time-stamp: "2024-12-05 10:34:16 (ywatanabe)"
# File: ./mngs_repo/tests/mngs/decorators/test__DataTypeDecorators.py

__file__ = "/home/ywatanabe/proj/mngs_repo/tests/mngs/decorators/test__DataTypeDecorators.py"

# src from here --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
# # Time-stamp: "2024-12-05 09:48:39 (ywatanabe)"
...
def run_tests():
    ...
    def run_batch_processing_tests():
        printc("run_batch_processing_tests")
    ...
    def run_positional_args_tests():
        printc("run_positional_args_tests")

        def run_basic_positional_tests():
            printc("run_basic_positional_tests")
        ...
        def run_method_positional_tests():
            printc("run_method_positional_tests")
    ...
    def run_combined_batch_tests():
        printc("run_combined_batch_tests")
...
"""
python ./mngs_repo/tests/mngs/decorators/test__DataTypeDecorators.py
python -m tests.mngs.decorators.test__DataTypeDecorators
"""
