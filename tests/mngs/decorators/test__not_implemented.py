...
# File: /data/gpfs/projects/punim2354/ywatanabe/.claude-worktree/mngs_repo/tests/mngs/decorators/test__not_implemented.py

"""
Comprehensive tests for mngs.decorators._not_implemented module.
...
class TestNotImplemented:
    """Test cases for mngs.decorators._not_implemented module."""
