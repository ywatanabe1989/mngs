...
# File: ./mngs_repo/tests/mngs/resource/test_limit_RAM.py
...
class TestLimitRAM:
    """Test cases for mngs.resource.limit_ram module."""
    ...
    def test_limit_ram_imports(self):
        ...
        from mngs.resource.limit_ram import limit_ram, get_ram
...
Inactive:        1000000 kB""")
    def test_get_ram_basic_functionality(self, mock_file):
        ...
        from mngs.resource.limit_ram import get_ram
...
Cached:          0 kB""")
    ...
    @patch('mngs.resource.limit_ram.get_ram')
    @patch('resource.getrlimit')
    @patch('resource.setrlimit')
    @patch('mngs.gen.fmt_size')
    ...
    def test_limit_ram_basic_functionality(self, mock_print, mock_fmt_size, mock_setrlimit, mock_getrlimit, mock_get_ram):
        ...
        from mngs.resource.limit_ram import limit_ram
    ...
    def test_backward_compatibility_limit_RAM(self):
        ...
        from mngs.resource.limit_ram import limit_ram, limit_RAM
    ...
    def test_backward_compatibility_get_RAM(self):
        ...
        from mngs.resource.limit_ram import get_ram, get_RAM
...
Cached:          def kB""")
    ...
    def test_limit_ram_integration_with_mngs_gen(self):
        """Test that limit_ram correctly integrates with mngs.gen.fmt_size."""
        # This is more of an integration test - we're testing that the import works
        from mngs.resource.limit_ram import limit_ram
        import mngs.gen
        
        # Verify that mngs.gen.fmt_size is accessible
        assert hasattr(mngs.gen, 'fmt_size')
        assert callable(mngs.gen.fmt_size)
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/resource/limit_RAM.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/resource/limit_RAM.py
# --------------------------------------------------------------------------------
>>>>>>> origin/main
