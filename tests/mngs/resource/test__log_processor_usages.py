...
# File: ./tests/mngs/resource/test__log_processor_usages.py
...
from mngs.resource._log_processor_usages import (
    _add,
    _ensure_log_file,
...
class TestLogProcessorUsages:
    ...
    @patch('mngs.resource._log_processor_usages._log_processor_usages')
    ...
    @patch('mngs.resource._log_processor_usages.Process')
    ...
    def test_default_parameters(self, mock_log):
        ...
        mock_log.assert_called_once_with(
            path="/tmp/mngs/processor_usages.csv",
            limit_min=30,
            interval_s=1,
            init=True,
            verbose=False
...
class TestLogProcessorUsagesInternal:
    ...
    @patch('mngs.resource._log_processor_usages.time.sleep')
    @patch('mngs.resource._log_processor_usages._add')
    @patch('mngs.resource._log_processor_usages._ensure_log_file')
...
class TestEnsureLogFile:
    ...
    @patch('mngs.resource._log_processor_usages.os.path.exists')
    @patch('mngs.resource._log_processor_usages.os.makedirs')
    @patch('mngs.resource._log_processor_usages.pd.DataFrame')
    @patch('mngs.resource._log_processor_usages.printc')
    ...
    @patch('mngs.resource._log_processor_usages.os.path.exists')
    @patch('mngs.resource._log_processor_usages.sh')
    @patch('mngs.resource._log_processor_usages.os.makedirs')
    @patch('mngs.resource._log_processor_usages.pd.DataFrame')
    @patch('mngs.resource._log_processor_usages.printc')
...
class TestAddFunction:
    ...
    @patch('mngs.resource._log_processor_usages.get_processor_usages')
