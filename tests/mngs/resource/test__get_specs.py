...
# File: ./tests/mngs/resource/test__get_specs.py
...
def test_get_specs_default():
    ...
    from mngs.resource._get_specs import get_specs

    with patch("mngs.resource._get_specs.get_env_info") as mock_env:
...
def test_get_specs_cpu_only():
    ...
    with patch("mngs.resource._get_specs.get_env_info") as mock_env, \
         patch("mngs.resource._get_specs._psutil") as mock_psutil:
...
def test_get_specs_yaml_output():
    ...
    with patch("mngs.resource._get_specs.get_env_info") as mock_env, \
         patch("mngs.resource._get_specs._yaml") as mock_yaml:
...
def test_system_info():
    ...
    from mngs.resource._get_specs import _system_info

    with patch("mngs.resource._get_specs._platform") as mock_platform, \
         patch("mngs.resource._get_specs._supple_os_info") as mock_os_info:
...
def test_cpu_info():
    ...
    from mngs.resource._get_specs import _cpu_info

    with patch("mngs.resource._get_specs._psutil") as mock_psutil:
        mock_psutil.cpu_count.side_effect = lambda logical=True: 8 if logical else 4
        mock_psutil.cpu_freq.return_value = MagicMock(max=3600.0, min=800.0, current=2400.0)
...
def test_memory_info():
    ...
    from mngs.resource._get_specs import _memory_info
...
def test_disk_info():
    ...
    from mngs.resource._get_specs import _disk_info
...
def test_network_info():
    ...
    from mngs.resource._get_specs import _network_info
...
def test_supple_os_info():
    ...
    from mngs.resource._get_specs import _supple_os_info

    with patch("mngs.resource._get_specs._SUPPLE_INFO", {
        "os": "Ubuntu 20.04",
        "gcc_version": "9.4.0",
...
def test_supple_python_info():
    ...
    from mngs.resource._get_specs import _supple_python_info
...
def test_supple_nvidia_info():
    ...
    from mngs.resource._get_specs import _supple_nvidia_info
...
def test_error_handling_in_subsystems():
    ...
    with patch("mngs.resource._get_specs.get_env_info") as mock_env, \
         patch("mngs.resource._get_specs._system_info") as mock_system, \
         patch("mngs.resource._get_specs._cpu_info") as mock_cpu:
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/resource/_get_specs.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/resource/_get_specs.py
# --------------------------------------------------------------------------------
>>>>>>> origin/main
