...
# File: ./tests/mngs/resource/test_limit_ram.py
...
@mock.patch('mngs.resource.limit_ram.resource.setrlimit')
@mock.patch('mngs.resource.limit_ram.resource.getrlimit')
@mock.patch('mngs.resource.limit_ram.get_ram')
...
def test_limit_ram_backward_compatibility():
    ...
    from mngs.resource.limit_ram import limit_RAM, get_RAM, limit_ram, get_ram
