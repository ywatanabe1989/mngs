...
# File: ./tests/mngs/ai/optim/Ranger_Deep_Learning_Optimizer/test_setup.py
...
class TestRangerSetup:
    ...
    def setup_dir(self):
        ...
        return Path(__file__).parent.parent.parent.parent.parent.parent / "src" / "mngs" / "ai" / "optim" / "Ranger_Deep_Learning_Optimizer"
