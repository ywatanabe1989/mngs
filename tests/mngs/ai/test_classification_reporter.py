#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Test for mngs.ai.classification_reporter
...
with patch('mngs.reproduce.fix_seeds') as mock_fix_seeds:
    from mngs.ai.classification_reporter import ClassificationReporter, MultiClassificationReporter
