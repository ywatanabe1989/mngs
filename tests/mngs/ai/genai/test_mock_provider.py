...
# File: ./mngs_repo/tests/mngs/ai/genai/test_mock_provider.py

"""Tests for mngs.ai.genai.mock_provider module using file-based structure approach.
...
class TestMockProviderModule:
    ...
    def test_mock_provider_module_exists(self):
        ...
        module_path = os.path.join(
            ...
            'mngs', 'ai', 'genai', 'mock_provider.py'
        )
