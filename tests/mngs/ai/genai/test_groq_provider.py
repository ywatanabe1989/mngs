...
# mngs/tests/mngs/ai/genai/test_groq_provider.py
...
from mngs.ai.genai.groq_provider import GroqProvider
from mngs.ai.genai.base_provider import CompletionResponse
from mngs.ai.genai.provider_base import ProviderConfig
...
class TestGroqProvider:
    ...
    def mock_groq_client(self):
        ...
        with patch('mngs.ai.genai.groq_provider.GroqClient') as mock:
            yield mock
    ...
    def test_stream(self, groq_provider, mock_groq_client):
        ...
        mock_groq_client.return_value.chat.completions.create.return_value = iter(mock_chunks)
