...
from mngs.ai.genai.provider_factory import (
    Provider, ProviderRegistry, register_provider, create_provider, GenAI
)
from mngs.ai.genai.base_provider import BaseProvider, ProviderConfig
...
class TestFactoryFunctions:
    ...
    def test_register_provider_function(self):
        ...
        with patch('mngs.ai.genai.provider_factory._registry') as mock_registry:
    ...
    @patch('mngs.ai.genai.provider_factory._auto_register')
    @patch('mngs.ai.genai.provider_factory._registry')
    ...
    @patch('mngs.ai.genai.provider_factory._auto_register')
    @patch('mngs.ai.genai.provider_factory._registry')
    @patch('mngs.ai.genai.provider_factory.ModelRegistry')
    def test_genai_with_model_name_only(self, mock_model_registry_class, mock_registry, mock_auto_register):
    ...
    def test_auto_register_called(self, mock_auto_register):
        ...
        import importlib
        import mngs.ai.genai.provider_factory
