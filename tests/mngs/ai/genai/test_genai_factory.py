...
# File: ./tests/mngs/ai/genai/test_genai_factory.py
...
def test_genai_factory_basic_functionality():
    ...
    from mngs.ai.genai.genai_factory import genai_factory
...
@patch('mngs.ai.genai.genai_factory.MODELS')
...
@patch('mngs.ai.genai.genai_factory.OpenAI')
def test_genai_factory_openai_creation(mock_openai):
    ...
    with patch('mngs.ai.genai.genai_factory.MODELS') as mock_models:
...
@patch('mngs.ai.genai.genai_factory.Anthropic')
