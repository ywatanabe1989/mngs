...
# File: ./tests/mngs/ai/genai/test_anthropic.py
...
def test_anthropic_class_import():
    ...
    from mngs.ai.genai.anthropic import Anthropic
...
def test_anthropic_inheritance():
    ...
    from mngs.ai.genai.anthropic import Anthropic
    from mngs.ai.genai.base_genai import BaseGenAI
    
    # Check inheritance
    assert issubclass(Anthropic, BaseGenAI)


@patch('mngs.ai.genai.anthropic.anthropic.Anthropic')
...
def test_anthropic_api_key_handling():
    ...
    with patch('mngs.ai.genai.anthropic.anthropic.Anthropic'):
        anthropic_instance = Anthropic(
            model="claude-3-opus-20240229",
...
def test_anthropic_module_constants():
    ...
    from mngs.ai.genai import anthropic as anthropic_module
