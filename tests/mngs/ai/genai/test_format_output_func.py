...
# File: ./tests/mngs/ai/genai/test_format_output_func.py
...
def test_format_output_basic_functionality():
    ...
    from mngs.ai.genai.format_output_func import format_output
...
@patch('mngs.ai.genai.format_output_func.markdown2.markdown')
