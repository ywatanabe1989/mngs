...
# File: ./tests/mngs/ai/genai/test___init__.py
...
def test_genai_module_all_exports():
    ...
    import mngs.ai.genai as genai_module
...
@patch('mngs.ai.genai.create_provider')
@patch('mngs.ai.genai.AuthManager')
@patch('mngs.ai.genai.CostTracker')
@patch('mngs.ai.genai.ChatHistory')
...
def test_genai_complete_method(mock_chat_history, mock_cost_tracker, mock_auth_manager, mock_create_provider):
    ...
    from mngs.ai.genai import GenAI, CompletionResponse
