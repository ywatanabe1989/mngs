...
# File: ./mngs_repo/tests/mngs/ai/genai/test_llama_provider.py
...
from mngs.ai.genai.llama_provider import LlamaProvider
from mngs.ai.genai.provider_factory import ProviderConfig
...
class TestLlamaProvider:
    ...
    def mock_llama(self):
        ...
        with patch('mngs.ai.genai.llama_provider._Llama') as mock:
    ...
    def test_init_no_llama_package(self, config):
        ...
        with patch('mngs.ai.genai.llama_provider._Llama', None):
    ...
    def test_complete(self, config, mock_llama):
        ...
        mock_generator.chat_completion.return_value = [
            {
                "generation": {
                    "content": "Hello! I'm Llama, how can I help you?"
                }
            }
        ]
    ...
    def test_build_failure(self, config):
        ...
        with patch('mngs.ai.genai.llama_provider._Llama') as mock_llama:
