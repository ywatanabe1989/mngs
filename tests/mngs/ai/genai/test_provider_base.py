...
# File: ./mngs_repo/tests/mngs/ai/genai/test_provider_base.py

"""Tests for mngs.ai.genai.provider_base module using file-based structure approach.
...
class TestProviderBaseModule:
    ...
    def test_provider_base_module_exists(self):
        ...
        module_path = os.path.join(
            ...
            'mngs', 'ai', 'genai', 'provider_base.py'
        )
