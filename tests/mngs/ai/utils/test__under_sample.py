...
# File: ./tests/mngs/ai/utils/test__under_sample.py

"""Tests for mngs.ai.utils._under_sample module."""
...
class TestUnderSample:
    ...
    def test_insufficient_samples_for_replacement_false(self):
        """Test when minority class has more samples than some other class."""
        # This is an edge case where class 1 has 3 samples, class 0 has only 2
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/ai/utils/_under_sample.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
#
#
...
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/ai/utils/_under_sample.py
# --------------------------------------------------------------------------------
