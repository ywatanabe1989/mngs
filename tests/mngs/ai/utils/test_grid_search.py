...
from mngs.ai.utils.grid_search import yield_grids, count_grids
...
class TestGridSearch:
    ...
    def test_yield_grids_random(self, simple_grid):
        ...
        assert set(tuple(sorted(d.items())) for d in random_combos) == \
               set(tuple(sorted(d.items())) for d in ordered_combos)
    ...
    def test_large_grid_performance(self):
        ...
        # Getting first item should be fast
        start = time.time()
        first = next(gen)
    ...
    def test_random_different_seeds(self, simple_grid):
        ...
        assert set(tuple(sorted(d.items())) for d in combos1) == \
               set(tuple(sorted(d.items())) for d in combos2)
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/ai/utils/grid_search.py
# --------------------------------------------------------------------------------
# #!./env/bin/python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/ai/utils/grid_search.py
# --------------------------------------------------------------------------------
