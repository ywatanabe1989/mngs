...
# File: /data/gpfs/projects/punim2354/ywatanabe/.claude-worktree/mngs_repo/tests/mngs/ai/sklearn/test_clf.py

"""
Comprehensive tests for mngs.ai.sklearn.clf module.
...
class TestRocketPipeline:
    ...
    def test_rocket_pipeline_returns_pipeline(self):
        ...
        from mngs.ai.sklearn.clf import rocket_pipeline
    ...
    @patch('mngs.ai.sklearn.clf.make_pipeline')
...
class TestGBPipeline:
    ...
    def test_gb_pipeline_is_pipeline(self):
        ...
        from mngs.ai.sklearn.clf import GB_pipeline
...
class TestErrorHandling:
    ...
    def test_pipeline_methods_exist(self):
        ...
        from mngs.ai.sklearn.clf import rocket_pipeline, GB_pipeline
