...
# File: ./mngs_repo/tests/mngs/ai/plt/aucs/test_example.py

"""Comprehensive tests for mngs.ai.plt.aucs.example module.
...
class TestAUCsExample:
    ...
    def test_example_imports(self):
        ...
        try:
            from mngs.ai.plt.aucs.example import (
                plt as example_plt,
                np as example_np,
                datasets,
                svm,
    ...
    @patch('mngs.ai.plt.aucs.roc_auc.roc_auc')
    @patch('mngs.ai.plt.aucs.pre_rec_auc.pre_rec_auc')
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/ai/plt/aucs/example.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/ai/plt/aucs/example.py
# --------------------------------------------------------------------------------
>>>>>>> origin/main
