...
# File: /home/ywatanabe/proj/_mngs_repo/tests/mngs/ai/plt/test__learning_curve.py
...
class TestLearningCurve:
    ...
    def test_basic_learning_curve(self, sample_metrics_df):
        ...
        with patch('mngs.plt.configure_mpl') as mock_config:
    ...
    def test_process_i_global(self):
        ...
        from mngs.ai.plt._learning_curve import process_i_global
    ...
    def test_set_yaxis_for_acc(self):
        ...
        from mngs.ai.plt._learning_curve import set_yaxis_for_acc
    ...
    def test_plot_tra(self, sample_metrics_df):
        ...
        from mngs.ai.plt._learning_curve import plot_tra
    ...
    def test_scatter_val(self, sample_metrics_df):
        ...
        from mngs.ai.plt._learning_curve import scatter_val
    ...
    def test_scatter_tes(self, sample_metrics_df):
        ...
        from mngs.ai.plt._learning_curve import scatter_tes
    ...
    def test_vline_at_epochs(self, sample_metrics_df):
        ...
        from mngs.ai.plt._learning_curve import vline_at_epochs
    ...
    def test_select_ticks(self, sample_metrics_df):
        ...
        from mngs.ai.plt._learning_curve import select_ticks
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/ai/plt/_learning_curve.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/ai/plt/_learning_curve.py
# --------------------------------------------------------------------------------
