...
# File: /home/ywatanabe/proj/_mngs_repo/tests/mngs/ai/plt/test___init__.py

"""
Comprehensive tests for mngs.ai.plt module initialization
"""
...
class TestAIPltInit:
    ...
    def test_module_import(self):
        ...
        import mngs.ai.plt
        assert mngs.ai.plt is not None
    ...
    def test_module_attributes(self):
        ...
        for attr in expected_attrs:
            assert hasattr(mngs.ai.plt, attr), f"Missing attribute: {attr}"
            
    def test_submodule_structure(self):
        """Test that the aucs submodule exists and is accessible"""
        import mngs.ai.plt.aucs
        assert mngs.ai.plt.aucs is not None
        assert hasattr(mngs.ai.plt.aucs, 'pre_rec_auc')
        assert hasattr(mngs.ai.plt.aucs, 'roc_auc')
        
    def test_no_unexpected_imports(self):
        """Test that no unexpected functions are imported at module level"""
        import mngs.ai.plt
        module_attrs = dir(mngs.ai.plt)
    ...
    def test_import_from_all(self):
        """Test import using from mngs.ai.plt import *"""
        ...
        test_namespace = {}
        exec("from mngs.ai.plt import *", test_namespace)
    ...
    def test_function_signatures(self):
        ...
        import inspect
        from mngs.ai.plt import conf_mat, learning_curve, optuna_study
    ...
    def test_module_reload(self):
        ...
        import mngs.ai.plt
        # First import
        conf_mat_1 = mngs.ai.plt.conf_mat
        
        # Reload module
        importlib.reload(mngs.ai.plt)
        
        # Check function is still available
        conf_mat_2 = mngs.ai.plt.conf_mat
    ...
    def test_circular_import_check(self):
        ...
        import mngs.ai.plt
        import mngs.ai.plt.aucs
        import mngs.ai.plt.aucs.pre_rec_auc
        import mngs.ai.plt.aucs.roc_auc
    ...
    def test_namespace_pollution(self):
        ...
        assert not hasattr(mngs.ai.plt, 'np')
        assert not hasattr(mngs.ai.plt, 'pd')
        assert not hasattr(mngs.ai.plt, 'matplotlib')
    ...
    def test_lazy_import_behavior(self):
        ...
        assert hasattr(mngs.ai.plt, 'conf_mat')
        assert hasattr(mngs.ai.plt, 'learning_curve')
        assert hasattr(mngs.ai.plt, 'optuna_study')
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/ai/plt/__init__.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# 
# from ._conf_mat import conf_mat
# from ._learning_curve import learning_curve
# from ._optuna_study import optuna_study
# from .aucs.pre_rec_auc import pre_rec_auc
# from .aucs.roc_auc import roc_auc

# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/ai/plt/__init__.py
# --------------------------------------------------------------------------------
>>>>>>> origin/main
