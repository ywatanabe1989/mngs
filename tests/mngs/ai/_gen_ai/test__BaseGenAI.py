...
"""Tests for mngs.ai._gen_ai._BaseGenAI module."""
...
class TestBaseGenAI:
    ...
    def gen_ai(self):
        ...
        with patch('mngs.ai._gen_ai._BaseGenAI.MODELS', {
            'name': ['test-model'],
    ...
    def test_list_models_all(self):
        ...
        with patch('mngs.ai._gen_ai._BaseGenAI.MODELS', mock_models):
    ...
    def test_call_with_prompt_file(self, gen_ai):
        ...
        with patch('mngs.ai._gen_ai._BaseGenAI.load', return_value=["Line 1", "Line 2"]):
            gen_ai.stream = False
    ...
    def test_cost_calculation(self, gen_ai):
        ...
        with patch('mngs.ai._gen_ai._BaseGenAI.calc_cost', return_value=0.15):
    ...
    def test_format_output(self, gen_ai):
        ...
        with patch('mngs.ai._gen_ai._BaseGenAI.format_output_func', return_value="Formatted"):
            gen_ai.stream = False
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/ai/_gen_ai/_BaseGenAI.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# # EOF
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/ai/_gen_ai/_BaseGenAI.py
# --------------------------------------------------------------------------------
>>>>>>> origin/main
