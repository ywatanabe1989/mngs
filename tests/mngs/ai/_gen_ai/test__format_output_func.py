...
# File: ./tests/mngs/ai/_gen_ai/test__format_output_func.py

"""Tests for mngs.ai._gen_ai._format_output_func module."""

import pytest
from mngs.ai._gen_ai._format_output_func import format_output_func
