...
# File: ./tests/mngs/ai/_gen_ai/test__Anthropic.py

"""Tests for mngs.ai._gen_ai._Anthropic module."""
...
class TestAnthropic:
    ...
    def test_init_with_api_key(self, mock_env_api_key):
        ...
        with patch('mngs.ai._gen_ai._Anthropic.MODELS', MagicMock()):
    ...
    def test_model_validation(self, mock_env_api_key):
        ...
        with patch('mngs.ai._gen_ai._Anthropic.MODELS', mock_models):
            with patch.object(Anthropic, '_init_client', return_value=Mock()):
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/ai/_gen_ai/_Anthropic.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# # EOF
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/ai/_gen_ai/_Anthropic.py
# --------------------------------------------------------------------------------
>>>>>>> origin/main
