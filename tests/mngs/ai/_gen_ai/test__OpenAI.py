...
# File: ./tests/mngs/ai/_gen_ai/test__OpenAI.py

"""Tests for mngs.ai._gen_ai._OpenAI module."""

import pytest
import os
from unittest.mock import Mock, MagicMock, patch
from mngs.ai._gen_ai._OpenAI import OpenAI
...
class TestOpenAI:
    ...
    def test_init_with_api_key(self, mock_env_api_key):
        ...
        with patch('mngs.ai._gen_ai._OpenAI.MODELS', MagicMock()):
    ...
    def test_init_client(self, mock_env_api_key):
        ...
        with patch('mngs.ai._gen_ai._OpenAI.MODELS', MagicMock()):
            with patch('mngs.ai._gen_ai._OpenAI._OpenAI') as mock_openai_class:
                mock_client = Mock()
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/ai/_gen_ai/_OpenAI.py
# --------------------------------------------------------------------------------
>>>>>>> origin/main
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/ai/_gen_ai/_OpenAI.py
# --------------------------------------------------------------------------------
