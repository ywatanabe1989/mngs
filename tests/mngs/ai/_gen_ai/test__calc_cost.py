...
# File: ./tests/mngs/ai/_gen_ai/test__calc_cost.py

"""Tests for mngs.ai._gen_ai._calc_cost module."""

import pytest
import pandas as pd
from unittest.mock import patch
from mngs.ai._gen_ai._calc_cost import calc_cost
...
class TestCalcCost:
    ...
    def test_calc_cost_gpt4(self, mock_models):
        ...
        with patch('mngs.ai._gen_ai._calc_cost.MODELS', mock_models):
    ...
    def test_calc_cost_with_real_models_dataframe(self):
        ...
        from mngs.ai._gen_ai._PARAMS import MODELS
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/ai/_gen_ai/_calc_cost.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/ai/_gen_ai/_calc_cost.py
# --------------------------------------------------------------------------------
>>>>>>> origin/main
