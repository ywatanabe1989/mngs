...
try:
    from mngs.ai.training.early_stopping import EarlyStopping
except ImportError:
...
class TestEarlyStoppingSave:
    ...
    @patch('mngs.ai.training.early_stopping.mngs.io.save')
    @patch('mngs.ai.training.early_stopping.mngs.str.printc')
