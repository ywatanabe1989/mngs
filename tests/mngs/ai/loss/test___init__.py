...
# File: /data/gpfs/projects/punim2354/ywatanabe/.claude-worktree/mngs_repo/tests/mngs/ai/loss/test___init__.py
# ----------------------------------------
...
class TestLossModuleInit:
    ...
    def test_module_imports(self):
        ...
        import mngs.ai.loss
        assert hasattr(mngs.ai.loss, "__name__")
    ...
    def test_direct_import_paths(self):
        ...
        # Test MultiTaskLoss
        from mngs.ai.loss.multi_task_loss import MultiTaskLoss as MTL1
        from mngs.ai.loss import MultiTaskLoss as MTL2
        assert MTL1 is MTL2

    def test_module_documentation(self):
        """Test module has proper documentation."""
        import mngs.ai.loss
        assert mngs.ai.loss.__doc__ is not None
        assert "Loss functions" in mngs.ai.loss.__doc__

    def test_no_unexpected_exports(self):
        """Test no unexpected items are exported."""
        import mngs.ai.loss
        # Get public exports (not starting with _)
        public_attrs = [attr for attr in dir(mngs.ai.loss) if not attr.startswith("_")]
    ...
    def test_submodule_structure(self):
        ...
        import mngs.ai.loss
        import os
        loss_dir = os.path.dirname(mngs.ai.loss.__file__)
    ...
    def test_import_performance(self):
        ...
        if "mngs.ai.loss" in sys.modules:
            del sys.modules["mngs.ai.loss"]
        
        start = time.time()
        importlib.import_module("mngs.ai.loss")
    ...
    def test_circular_imports(self):
        ...
        import mngs.ai.loss
        from mngs.ai.loss import MultiTaskLoss
        from mngs.ai.loss import l1, l2, elastic
