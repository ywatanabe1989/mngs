...
- Legend generation
- Integration with mngs plotting
"""
...
class TestPlotFunction:
    ...
    def test_plot_single_dataset(self):
        ...
        from mngs.ai.clustering._umap import _plot
        import umap.umap_ as umap_orig
...
class TestMainAlias:
    ...
    def test_main_is_umap(self):
        ...
        from mngs.ai.clustering._umap import main, umap
...
class TestIntegration:
    ...
    def test_test_function_iris(self, mock_save):
        ...
        # Mock mngs.gen.start to avoid display issues
        with patch('mngs.gen.start') as mock_start:
...
class TestVisualization:
    ...
    def test_axis_labels(self):
        ...
        # Check labels
        # The exact method depends on mngs.plt implementation
