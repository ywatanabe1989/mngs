...
# File: /data/gpfs/projects/punim2354/ywatanabe/.claude-worktree/mngs_repo/tests/mngs/ai/layer/test__Pass_enhanced.py
# ----------------------------------------
...
__FILE__ = "./tests/mngs/ai/layer/test__Pass_enhanced.py"
