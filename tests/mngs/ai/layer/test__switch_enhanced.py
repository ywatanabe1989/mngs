...
# File: /data/gpfs/projects/punim2354/ywatanabe/.claude-worktree/mngs_repo/tests/mngs/ai/layer/test__switch_enhanced.py
# ----------------------------------------
...
from mngs.ai.layer import switch, Pass

__FILE__ = "./tests/mngs/ai/layer/test__switch_enhanced.py"
