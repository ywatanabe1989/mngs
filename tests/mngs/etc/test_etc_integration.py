...
# File: /data/gpfs/projects/punim2354/ywatanabe/.claude-worktree/mngs_repo/tests/mngs/etc/test_etc_integration.py
# ----------------------------------------
...
__FILE__ = "./tests/mngs/etc/test_etc_integration.py"
...
class TestEtcIntegration:
    ...
    def test_interactive_process_control(self):
        ...
        with patch('mngs.etc.wait_key.readchar.readchar', side_effect=['s', 't', 'a', 't', 'q']):
    ...
    def test_monitoring_with_keyboard_interrupt(self):
        ...
        with patch('mngs.etc.wait_key.readchar.readchar', side_effect=['m', 'q']):
    ...
    def test_multi_process_coordination(self):
        ...
        # Simulate user interaction
        with patch('mngs.etc.wait_key.readchar.readchar', side_effect=['1', '2', '3', 'q']):
            with patch('builtins.print') as mock_print:
                wait_key(manager)
    ...
    def test_count_with_data_collection(self):
        ...
        with patch('mngs.etc.count', enhanced_count):
            from mngs.etc import count
            with patch('builtins.print'):
                count()
    ...
    def test_real_world_usage_pattern(self):
        ...
        with patch('mngs.etc.wait_key.readchar.readchar', side_effect=['s', 'q']):
            with patch('builtins.print'):
                wait_key(app)
