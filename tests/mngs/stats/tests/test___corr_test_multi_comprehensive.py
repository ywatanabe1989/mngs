...
class TestComputeSurrogate:
    ...
    def test_compute_surrogate_pearson(self):
        ...
        from mngs.stats.tests.__corr_test_multi import _compute_surrogate
...
class TestCorrTestBase:
    ...
    def test_corr_test_base_pearson(self):
        ...
        from mngs.stats.tests.__corr_test_multi import _corr_test_base
...
class TestCorrTestFunctions:
    ...
    def test_corr_test_pearson(self):
        ...
        from mngs.stats.tests.__corr_test_multi import corr_test_pearson
    ...
    def test_corr_test_spearman(self):
        ...
        from mngs.stats.tests.__corr_test_multi import corr_test_spearman
    ...
    def test_corr_test_main_function(self):
        ...
        from mngs.stats.tests.__corr_test_multi import corr_test
