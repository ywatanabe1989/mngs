...
# File: tests/mngs/stats/tests/test__smirnov_grubbs.py
...
class TestSmirnovGrubbs:
    ...
    def test_basic_functionality(self):
        ...
        result = mngs.stats.tests._smirnov_grubbs.smirnov_grubbs(data)
    ...
    def test_alpha_parameter(self):
        ...
        result_strict = mngs.stats.tests._smirnov_grubbs.smirnov_grubbs(data, alpha=0.01)
        
        # Less strict (higher alpha)
        result_lenient = mngs.stats.tests._smirnov_grubbs.smirnov_grubbs(data, alpha=0.1)
    ...
    def test_preserve_original_data(self):
        ...
        mngs.stats.tests._smirnov_grubbs.smirnov_grubbs(data)
    ...
    def test_float_vs_int_consistency(self):
        ...
        result_int = mngs.stats.tests._smirnov_grubbs.smirnov_grubbs(data_int)
        result_float = mngs.stats.tests._smirnov_grubbs.smirnov_grubbs(data_float)
