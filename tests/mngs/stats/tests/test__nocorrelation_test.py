...
# File: tests/mngs/stats/tests/test__nocorrelation_test.py
...
class TestNoCorrelationTest:
    ...
    def test_basic_functionality(self):
        ...
        r, t, p_value = mngs.stats.tests._nocorrelation_test.nocorrelation_test(x, y)
    ...
    def test_partial_correlation(self):
        ...
        r_simple, _, _ = mngs.stats.tests._nocorrelation_test.nocorrelation_test(x, y)
        
        # With controlling for z (partial correlation)
        r_partial, t_partial, p_partial = mngs.stats.tests._nocorrelation_test.nocorrelation_test(x, y, z)
    ...
    def test_p_value_range(self):
        ...
        _, _, p_value = mngs.stats.tests._nocorrelation_test.nocorrelation_test(x, y)
    ...
    def test_correlation_coefficient_range(self):
        ...
        r, _, _ = mngs.stats.tests._nocorrelation_test.nocorrelation_test(x, y)
    ...
    def test_t_statistic_positive(self):
        ...
        _, t, _ = mngs.stats.tests._nocorrelation_test.nocorrelation_test(x, y)
    ...
    def test_identical_arrays(self):
        ...
        r, t, p_value = mngs.stats.tests._nocorrelation_test.nocorrelation_test(x, x)
    ...
    def test_partial_correlation_independence(self):
        ...
        r_partial, _, p_partial = mngs.stats.tests._nocorrelation_test.nocorrelation_test(x, y, z)
    ...
    def test_statistical_properties(self):
        ...
        for _ in range(100):
            x = np.random.randn(30)
            y = np.random.randn(30)
            _, _, p = mngs.stats.tests._nocorrelation_test.nocorrelation_test(x, y)
            p_values.append(p)
    ...
    def test_calc_partial_corrcoef_helper(self):
        ...
        if hasattr(mngs.stats.tests._nocorrelation_test, 'calc_partial_corrcoef'):
            r_partial = mngs.stats.tests._nocorrelation_test.calc_partial_corrcoef(x, y, z)
    ...
    def test_correlation_matrix_symmetry(self):
        ...
        r1, _, _ = mngs.stats.tests._nocorrelation_test.nocorrelation_test(x, y)
        r2, _, _ = mngs.stats.tests._nocorrelation_test.nocorrelation_test(y, x)
    ...
    def test_alpha_parameter_ignored(self):
        ...
        result1 = mngs.stats.tests._nocorrelation_test.nocorrelation_test(x, y)
        # If alpha parameter exists, it shouldn't affect output
        try:
            result2 = mngs.stats.tests._nocorrelation_test.nocorrelation_test(x, y, alpha=0.01)
