...
# File: tests/mngs/stats/tests/test__brunner_munzel_test.py
...
class TestBrunnerMunzelTest:
    ...
    def test_basic_functionality(self):
        ...
        x1 = [1, 2, 3, 4, 5]
        x2 = [2, 3, 4, 5, 6]
        result = mngs.stats.tests._brunner_munzel_test.brunner_munzel_test(x1, x2)
    ...
    def test_t_distribution(self):
        ...
        result = mngs.stats.tests._brunner_munzel_test.brunner_munzel_test(
    ...
    def test_invalid_distribution(self):
        ...
        with pytest.raises(ValueError, match="Distribution must be either 't' or 'normal'"):
            mngs.stats.tests._brunner_munzel_test.brunner_munzel_test(
    ...
    def test_all_nan_input(self):
        ...
        with pytest.raises(ValueError, match="Input arrays must not be empty"):
            mngs.stats.tests._brunner_munzel_test.brunner_munzel_test(x1, x2)
    ...
    def test_round_factor(self):
        ...
        result1 = mngs.stats.tests._brunner_munzel_test.brunner_munzel_test(
            x1, x2, round_factor=1
        )
        result2 = mngs.stats.tests._brunner_munzel_test.brunner_munzel_test(
    ...
    def test_identical_samples(self):
        ...
        result = mngs.stats.tests._brunner_munzel_test.brunner_munzel_test(x, x)
    ...
    def test_reproducibility(self):
        ...
        result1 = mngs.stats.tests._brunner_munzel_test.brunner_munzel_test(x1, x2)
        result2 = mngs.stats.tests._brunner_munzel_test.brunner_munzel_test(x1, x2)
    ...
    def test_integration_with_statistical_tests(self):
        ...
        bm_result = mngs.stats.tests._brunner_munzel_test.brunner_munzel_test(x1, x2)
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/stats/tests/_brunner_munzel_test.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
# # Time-stamp: "2024-10-07 22:30:46 (ywatanabe)"
# # File: /home/ywatanabe/proj/_mngs_repo_openhands/src/mngs/stats/_brunner_munzel_test.py
#
# """
# 1. Functionality:
...
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/stats/tests/_brunner_munzel_test.py
# --------------------------------------------------------------------------------
