...
# File: ./mngs_repo/tests/mngs/stats/tests/test___corr_test_single.py
...
from mngs.stats.tests.__corr_test_single import (
    _corr_test_base,
    corr_test_spearman,
    corr_test_pearson,
    corr_test
...
class TestCorrTestSpearman:
    ...
    def test_spearman_parameters(self):
        ...
        with patch('mngs.stats.tests.__corr_test_single._corr_test_base') as mock_base:
...
class TestCorrTest:
    ...
    def test_corr_test_parameter_forwarding(self):
        ...
        with patch('mngs.stats.tests.__corr_test_single.corr_test_pearson') as mock_pearson:
        ...
        with patch('mngs.stats.tests.__corr_test_single.corr_test_spearman') as mock_spearman:
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/stats/tests/__corr_test_single.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# 
#     stars = mngs.stats.p2stars(pvalue)
...
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/stats/tests/__corr_test_single.py
# --------------------------------------------------------------------------------
>>>>>>> origin/main
