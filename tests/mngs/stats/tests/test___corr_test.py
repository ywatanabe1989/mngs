...
# File: ./tests/mngs/stats/tests/test___corr_test.py

"""
Test module for mngs.stats.tests._corr_test
"""
...
class TestCorrTest:
    ...
    def test_corr_test_spearman(self, sample_data):
        ...
        from mngs.stats.tests._corr_test import corr_test_spearman
    ...
    def test_corr_test_pearson(self, sample_data):
        ...
        from mngs.stats.tests._corr_test import corr_test_pearson
    ...
    def test_corr_test_with_nan(self, sample_data):
        ...
        from mngs.stats.tests._corr_test import corr_test
    ...
    def test_compute_surrogate(self):
        ...
        from mngs.stats.tests._corr_test import _compute_surrogate
...
=======
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/stats/tests/__corr_test.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/stats/tests/__corr_test.py
# --------------------------------------------------------------------------------
>>>>>>> origin/main
