#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Comprehensive tests for mngs.stats module.

This module contains comprehensive tests for all statistical analysis utilities
in the mngs.stats module, covering descriptive statistics, correlation analysis,
...
class TestDescriptiveStatistics:
    ...
    def test_real_statistics(self):
        ...
        real_stats = mngs.stats.real(data)
...
class TestCorrelationAnalysis:
    ...
    def test_partial_correlation(self):
        ...
        partial_corr = mngs.stats.calc_partial_corr(x, y, z)
    ...
    def test_partial_correlation_dataframe(self):
        ...
        partial_corr = mngs.stats.calc_partial_corr(df["x"], df["y"], df["z"])
        assert isinstance(partial_corr, float)
    ...
    def test_correlation_test_multiple(self):
        ...
        result = mngs.stats.corr_test_multi(data)
    ...
    def test_no_correlation_test(self):
        ...
        result = mngs.stats.nocorrelation_test(x, y)
...
class TestStatisticalTests:
    ...
    def test_brunner_munzel_test(self):
        ...
        result = mngs.stats.brunner_munzel_test(sample1, sample2)
    ...
    def test_smirnov_grubbs_outlier_test(self):
        ...
        result = mngs.stats.smirnov_grubbs(data)
...
class TestPValueFormatting:
    ...
    def test_p2stars_basic(self):
        ...
        assert mngs.stats.p2stars(0.1) == "ns"
        assert mngs.stats.p2stars(0.5) == "ns"
    ...
    def test_p2stars_custom_thresholds(self):
        ...
        result = mngs.stats.p2stars(0.009, thresholds=thresholds, symbols=symbols)
        assert result == "††"
...
class TestMultipleTestingCorrections:
    ...
    def test_bonferroni_with_alpha(self):
        ...
        result = mngs.stats.bonferroni_correction(p_values, alpha=alpha)
    ...
    def test_fdr_correction(self):
        ...
        result = mngs.stats.fdr_correction(p_values)
...
class TestEdgeCases:
    ...
    def test_empty_data(self):
        ...
        with pytest.raises((ValueError, IndexError)):
            mngs.stats.describe(empty_array)

    def test_single_value(self):
        """Test functions with single value."""
        single_value = np.array([42])

        result = mngs.stats.describe(single_value)
...
class TestIntegration:
    ...
    def test_complete_analysis_pipeline(self):
        ...
        for name, data in groups.items():
            descriptives[name] = mngs.stats.describe(data)

        # Step 2: Multiple comparisons
        groups_list = [control, treatment1, treatment2, treatment3]
        comparison_result = mngs.stats.multicompair(groups_list)
    ...
    def test_correlation_analysis_pipeline(self):
        ...
        corr_matrix = mngs.stats.corr_test_multi(data)

        # Test partial correlations
        partial_corr_income_health = mngs.stats.calc_partial_corr(
        ...
        if hasattr(corr_matrix, "values"):
            ...
            fdr_results = mngs.stats.fdr_correction(p_values_flat)
