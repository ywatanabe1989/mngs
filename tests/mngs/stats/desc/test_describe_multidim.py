...
class TestDescribeMultiDim:
    ...
    def test_describe_single_dim(self):
        ...
        result, func_names = mngs.stats.desc.describe(x, dim=1)
    ...
    def test_describe_multiple_dims(self):
        ...
        result, func_names = mngs.stats.desc.describe(x, dim=(1, 2, 3))
    ...
    def test_describe_with_axis_parameter(self):
        ...
        x = np.random.randn(10, 5, 4, 3)
        result, func_names = mngs.stats.desc.describe(x, axis=(1, 2, 3))
    ...
    def test_describe_all_functions(self):
        ...
        result, func_names = mngs.stats.desc.describe(x, dim=(1, 2), funcs="all")
    ...
    def test_describe_custom_functions(self):
        ...
        result, func_names = mngs.stats.desc.describe(x, dim=(1, 2), funcs=funcs)
    ...
    def test_describe_keepdims(self):
        ...
        x = np.random.randn(10, 5, 4, 3)
        result, func_names = mngs.stats.desc.describe(x, dim=(1, 2, 3), keepdims=True)
    ...
    def test_quantile_functions_multidim(self):
        ...
        q25_result = mngs.stats.desc._nan.nanq25(x, dim=(1, 2, 3), keepdims=False)
        q50_result = mngs.stats.desc._nan.nanq50(x, dim=(1, 2, 3), keepdims=False)
        q75_result = mngs.stats.desc._nan.nanq75(x, dim=(1, 2, 3), keepdims=False)
    ...
    def test_bug_report_case(self):
        ...
        try:
            result, func_names = mngs.stats.desc.describe(features_pac_z, axis=(1, 2, 3))
