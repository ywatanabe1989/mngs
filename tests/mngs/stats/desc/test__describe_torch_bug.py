...
# File: ./mngs_repo/tests/mngs/stats/desc/test__describe_torch_bug.py
...
class TestDescribeTorchBugFix:
    ...
    def test_original_bug_case(self):
        ...
        # mngs.stats.desc.describe(torch.tensor(features_pac_z), axis=(1, 2, 3))
        ...
        out = mngs.stats.desc.describe(tensor_input, axis=(1, 2, 3))
    ...
    def test_multiple_dimensions(self):
        ...
        for axes, expected_shape in test_cases:
            result, stats = mngs.stats.desc.describe(data, axis=axes)
    ...
    def test_nested_lists_input(self):
        ...
        result, stats = mngs.stats.desc.describe(nested_data, axis=1)
    ...
    def test_with_numpy_input(self):
        ...
        result, stats = mngs.stats.desc.describe(data, axis=(1, 2))
    ...
    def test_keepdims_parameter(self):
        ...
        # With keepdims=True
        result_keep, _ = mngs.stats.desc.describe(data, dim=(1, 2), keepdims=True)
        assert result_keep.shape == (10, 1, 1, 7)
        
        # With keepdims=False (default)
        result_no_keep, _ = mngs.stats.desc.describe(data, dim=(1, 2), keepdims=False)
    ...
    def test_single_dimension_reduction(self):
        ...
        result, stats = mngs.stats.desc.describe(data, dim=1)
    ...
    def test_batch_processing(self):
        ...
        result, stats = mngs.stats.desc.describe(data, dim=(1, 2), batch_size=10)
        
        assert result.shape == (100, 7)
        
        # Verify results are consistent with full processing
        result_full, _ = mngs.stats.desc.describe(data, dim=(1, 2), batch_size=-1)
    ...
    def test_custom_functions_list(self):
        ...
        result, stats = mngs.stats.desc.describe(
            data, 
            dim=1, 
    ...
    def test_all_functions(self):
        ...
        result, stats = mngs.stats.desc.describe(data, dim=1, funcs="all")
...
class TestDescribeEdgeCases:
    ...
    def test_single_element(self):
        ...
        result, stats = mngs.stats.desc.describe(data, dim=(1, 2))
