...
class TestDescModuleImports:
    ...
    def test_functions_available(self):
        ...
        assert hasattr(mngs.stats.desc, "describe")
        assert hasattr(mngs.stats.desc, "nan")
        assert hasattr(mngs.stats.desc, "real")
    ...
    def test_module_namespace(self):
        ...
        desc_attrs = dir(mngs.stats.desc)
...
class TestDescIntegration:
    ...
    def test_describe_with_different_inputs(self):
        ...
        result_arr = mngs.stats.desc.describe(arr)
        assert result_arr is not None
        
        # Pandas Series
        series = pd.Series(arr)
        result_series = mngs.stats.desc.describe(series)
        assert result_series is not None
        
        # Pandas DataFrame
        df = pd.DataFrame({"A": arr, "B": arr * 2})
        result_df = mngs.stats.desc.describe(df)
    ...
    def test_nan_and_real_consistency(self):
        ...
        # Get nan info
        nan_info = mngs.stats.desc.nan(data)
        
        # Get real values
        real_values = mngs.stats.desc.real(data)
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/stats/desc/__init__.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
<<<<<<< HEAD
# End of Source Code from: /home/ywatanabe/proj/_mngs_repo/src/mngs/stats/desc/__init__.py
# --------------------------------------------------------------------------------
=======
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/stats/desc/__init__.py
# --------------------------------------------------------------------------------
>>>>>>> origin/main
