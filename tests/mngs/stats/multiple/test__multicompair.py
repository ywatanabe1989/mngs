#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# File: ./tests/mngs/stats/multiple/test__multicompair.py
...
class TestImports:
    ...
    def test_import_target(self):
        import mngs.stats.multiple._multicompair
...
class TestMulticompair:
    ...
    def test_basic_functionality(self):
        ...
        result = mngs.stats.multiple._multicompair.multicompair(data, labels)
    ...
    def test_with_custom_test_function(self):
        ...
        result = mngs.stats.multiple._multicompair.multicompair(
...
class TestIntegration:
    ...
    def test_real_world_example(self):
        ...
        result_tukey = mngs.stats.multiple._multicompair.multicompair(data, labels)
        ...
        result_custom = mngs.stats.multiple._multicompair.multicompair(
    ...
    def test_edge_cases(self):
        ...
        result_identical = mngs.stats.multiple._multicompair.multicompair(
