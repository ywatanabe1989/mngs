#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# File: ./tests/mngs/stats/multiple/test__bonferroni_correction.py
...
class TestImports:
    ...
    def test_import_target(self):
        import mngs.stats.multiple._bonferroni_correction
...
class TestBonferroniCorrection:
    ...
    def test_basic_functionality(self):
        ...
        reject, p_corrected = mngs.stats.multiple._bonferroni_correction.bonferroni_correction(p_values, alpha=0.05)
    ...
    def test_rejection_logic(self):
        ...
        # With alpha=0.15
        reject2, _ = mngs.stats.multiple._bonferroni_correction.bonferroni_correction(p_values, alpha=0.15)
    ...
    def test_clipping_to_one(self):
        ...
        reject, p_corrected = mngs.stats.multiple._bonferroni_correction.bonferroni_correction(p_values)
    ...
    def test_single_p_value(self):
        ...
        reject, p_corrected = mngs.stats.multiple._bonferroni_correction.bonferroni_correction(p_value, alpha=0.05)
    ...
    def test_different_input_types(self):
        ...
        reject, p_corrected = mngs.stats.multiple._bonferroni_correction.bonferroni_correction(p_list)
        assert isinstance(p_corrected, np.ndarray)
        
        # Scalar input
        p_scalar = 0.01
        reject, p_corrected = mngs.stats.multiple._bonferroni_correction.bonferroni_correction(p_scalar)
...
class TestBonferroniCorrectionTorch:
    ...
    def test_basic_functionality(self):
        ...
        reject, p_corrected = mngs.stats.multiple._bonferroni_correction.bonferroni_correction_torch(p_values, alpha=0.05)
    ...
    def test_consistency_with_numpy(self):
        ...
        reject_np, p_corrected_np = mngs.stats.multiple._bonferroni_correction.bonferroni_correction(p_values_np)
        reject_torch, p_corrected_torch = mngs.stats.multiple._bonferroni_correction.bonferroni_correction_torch(p_values_torch)
    ...
    def test_different_dtypes(self):
        ...
        reject32, p_corrected32 = mngs.stats.multiple._bonferroni_correction.bonferroni_correction_torch(p_values_float32)
        reject64, p_corrected64 = mngs.stats.multiple._bonferroni_correction.bonferroni_correction_torch(p_values_float64)
...
class TestBonferroniWrapper:
    ...
    def test_wrapper_functionality(self):
        ...
        p_corrected = mngs.stats.bonferroni_correction(p_values, alpha=0.05)
    ...
    def test_wrapper_with_different_alpha(self):
        ...
        p_corrected1 = mngs.stats.bonferroni_correction(p_values, alpha=0.01)
        p_corrected2 = mngs.stats.bonferroni_correction(p_values, alpha=0.10)
...
class TestIntegration:
    ...
    def test_fwer_control(self):
        ...
        for _ in range(n_simulations):
            ...
            # Apply Bonferroni
            reject, _ = mngs.stats.multiple._bonferroni_correction.bonferroni_correction(p_values, alpha=alpha)
    ...
    def test_edge_cases(self):
        ...
        reject, p_corrected = mngs.stats.multiple._bonferroni_correction.bonferroni_correction(p_all_sig, alpha=0.05)
        assert np.all(reject)
        
        # No p-values significant
        p_none_sig = np.array([0.5, 0.6, 0.7])
        reject, p_corrected = mngs.stats.multiple._bonferroni_correction.bonferroni_correction(p_none_sig, alpha=0.05)
        assert not np.any(reject)
        
        # Exactly at threshold
        p_threshold = np.array([0.05/3, 0.05/3, 0.05/3])
        reject, p_corrected = mngs.stats.multiple._bonferroni_correction.bonferroni_correction(p_threshold, alpha=0.05)
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/stats/multiple/_bonferroni_correction.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
...
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/stats/multiple/_bonferroni_correction.py
# --------------------------------------------------------------------------------
>>>>>>> origin/main
