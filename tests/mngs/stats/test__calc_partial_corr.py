...
class TestCalcPartialCorr:
    ...
    def test_array_like_inputs(self):
        ...
        result_list = mngs.stats.calc_partial_corr(x_list, y_list, z_list)
        ...
        result_series = mngs.stats.calc_partial_corr(df['x'], df['y'], df['z'])
    ...
    def test_edge_cases(self):
        ...
        with pytest.warns(RuntimeWarning):
            result = mngs.stats.calc_partial_corr(x_const, y_const, z_const)
    ...
    def test_real_world_example(self):
        ...
        partial_corr = mngs.stats.calc_partial_corr(income, health, age)
...
class TestPartialCorrValidation:
    ...
    def test_minimum_samples(self):
        ...
        result = mngs.stats.calc_partial_corr(x, y, z)
