...
# File: ./tests/mngs/stats/test__multiple_corrections.py
...
def test_bonferroni_correction_basic():
    ...
    from mngs.stats._multiple_corrections import bonferroni_correction
...
def test_fdr_correction_basic():
    ...
    from mngs.stats._multiple_corrections import fdr_correction
...
def test_bonferroni_vs_fdr():
    ...
    from mngs.stats._multiple_corrections import bonferroni_correction, fdr_correction
...
@patch('mngs.stats._multiple_corrections._bonf_impl')
...
@patch('mngs.stats._multiple_corrections._fdr_impl')
