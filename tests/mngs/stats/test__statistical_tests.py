...
# File: ./tests/mngs/stats/test__statistical_tests.py
...
def test_statistical_tests_brunner_munzel_test_exists():
    ...
    from mngs.stats._statistical_tests import brunner_munzel_test
...
def test_statistical_tests_smirnov_grubbs_exists():
    ...
    from mngs.stats._statistical_tests import smirnov_grubbs
...
def test_statistical_tests_imports():
    ...
    from mngs.stats._statistical_tests import brunner_munzel_test, smirnov_grubbs
    assert brunner_munzel_test is not None
    assert smirnov_grubbs is not None
...
def test_statistical_tests_module_structure():
    ...
    import mngs.stats._statistical_tests as stats_tests
