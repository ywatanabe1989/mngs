...
# File: ./tests/mngs/pd/test__find_pval.py
...
class TestFindPvalDataFrame:
    ...
    def test_single_pval_column(self):
        ...
        from mngs.pd._find_pval import find_pval
...
class TestFindPvalDocumentation:
    ...
    def test_function_alias(self):
        ...
        from mngs.pd._find_pval import _find_pval_col
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/pd/_find_pval.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/pd/_find_pval.py
# --------------------------------------------------------------------------------
>>>>>>> origin/main
