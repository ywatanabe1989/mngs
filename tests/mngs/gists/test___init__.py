...
# File: tests/mngs/gists/test___init__.py
...
class TestGistsModule:
    """Test suite for mngs.gists module."""

    def test_sigmaplot_macro_imports(self):
        """Test that SigmaPlot macro functions can be imported from mngs.gists."""
        from mngs.gists import SigMacro_processFigure_S, SigMacro_toBlue
    ...
    def test_module_attributes(self):
        """Test that mngs.gists module has expected attributes."""
        import mngs.gists
        
        assert hasattr(mngs.gists, 'SigMacro_processFigure_S')
        assert hasattr(mngs.gists, 'SigMacro_toBlue')
        assert callable(mngs.gists.SigMacro_processFigure_S)
        assert callable(mngs.gists.SigMacro_toBlue)
    ...
    def test_sigmaplot_process_figure_output(self):
        ...
        from mngs.gists import SigMacro_processFigure_S
    ...
    def test_sigmaplot_to_blue_output(self):
        ...
        from mngs.gists import SigMacro_toBlue
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/gists/__init__.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
# # Time-stamp: "2024-02-03 16:00:30 (ywatanabe)"
# 
# from ._SigMacro_processFigure_S import SigMacro_processFigure_S
# from ._SigMacro_toBlue import SigMacro_toBlue

# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/gists/__init__.py
# --------------------------------------------------------------------------------
>>>>>>> origin/main
