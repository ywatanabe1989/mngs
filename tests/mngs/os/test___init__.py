...
# File: tests/mngs/os/test___init__.py
...
class TestOsModule:
    """Test suite for mngs.os module."""

    def test_mv_import(self):
        """Test that mv function can be imported from mngs.os."""
        from mngs.os import mv
    ...
    def test_module_attributes(self):
        """Test that mngs.os module has expected attributes."""
        import mngs.os
        
        assert hasattr(mngs.os, 'mv')
        assert callable(mngs.os.mv)
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/os/__init__.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# #     warnings.warn(f"Warning: Failed to import mv from ._mv.")

# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/os/__init__.py
# --------------------------------------------------------------------------------
>>>>>>> origin/main
