...
# File: ./mngs_repo/tests/mngs/linalg/test__geometric_median.py
...
class TestGeometricMedianBasic:
    ...
    def test_import(self):
        ...
        from mngs.linalg._geometric_median import geometric_median
    ...
    def test_basic_1d(self):
        ...
        with patch('mngs.linalg._geometric_median.compute_geometric_median') as mock_compute:
...
class TestGeometricMedianDimensions:
    ...
    def test_dim_out_of_range(self):
        ...
        with patch('mngs.linalg._geometric_median.compute_geometric_median'):
            # These should raise errors during indexing
            with pytest.raises((IndexError, RuntimeError)):
                geometric_median(x, dim=3)  # Too large
                
            with pytest.raises((IndexError, RuntimeError)):
                geometric_median(x, dim=-4)  # Too negative
