...
# File: ./mngs_repo/tests/mngs/linalg/test__misc_comprehensive.py
...
class TestEdgeCasesAndIntegration:
    ...
    def test_vector_operations_consistency(self):
        ...
        from mngs.linalg._misc import cosine, nannorm, rebase_a_vec
    ...
    def test_numerical_stability(self):
        ...
        from mngs.linalg._misc import cosine, nannorm
...
class TestDocumentation:
    ...
    def test_function_signatures(self):
        ...
        from mngs.linalg._misc import cosine, nannorm, rebase_a_vec, three_line_lengths_to_coords
        import inspect
