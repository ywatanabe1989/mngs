...
# File: tests/mngs/linalg/test___init__.py
...
class TestLinalgModule:
    """Test suite for mngs.linalg module."""

    def test_distance_imports(self):
        """Test that distance functions can be imported from mngs.linalg."""
        from mngs.linalg import cdist, euclidean_distance, edist
    ...
    def test_geometric_median_import(self):
        """Test that geometric_median can be imported from mngs.linalg."""
        from mngs.linalg import geometric_median
        
        assert callable(geometric_median)

    def test_misc_imports(self):
        """Test that miscellaneous functions can be imported from mngs.linalg."""
        from mngs.linalg import cosine, nannorm, rebase_a_vec, three_line_lengths_to_coords
    ...
    def test_module_attributes(self):
        """Test that mngs.linalg module has all expected attributes."""
        import mngs.linalg
        
        # Distance functions
        assert hasattr(mngs.linalg, 'cdist')
        assert hasattr(mngs.linalg, 'euclidean_distance')
        assert hasattr(mngs.linalg, 'edist')
        
        # Geometric median
        assert hasattr(mngs.linalg, 'geometric_median')
        
        # Miscellaneous functions
        assert hasattr(mngs.linalg, 'cosine')
        assert hasattr(mngs.linalg, 'nannorm')
        assert hasattr(mngs.linalg, 'rebase_a_vec')
        assert hasattr(mngs.linalg, 'three_line_lengths_to_coords')

    def test_cdist_basic_functionality(self):
        """Test basic cdist functionality."""
        from mngs.linalg import cdist
    ...
    def test_euclidean_distance_basic_functionality(self):
        ...
        from mngs.linalg import euclidean_distance
    ...
    def test_cosine_basic_functionality(self):
        ...
        from mngs.linalg import cosine
    ...
    def test_nannorm_basic_functionality(self):
        ...
        from mngs.linalg import nannorm
    ...
    def test_rebase_a_vec_basic_functionality(self):
        ...
        from mngs.linalg import rebase_a_vec
    ...
    def test_three_line_lengths_to_coords_basic_functionality(self):
        ...
        from mngs.linalg import three_line_lengths_to_coords
    ...
    def test_numpy_array_compatibility(self):
        ...
        from mngs.linalg import euclidean_distance, cosine
