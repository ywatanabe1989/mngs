...
# File: ./mngs_repo/tests/mngs/linalg/test__distance_enhanced.py
...
class TestEuclideanDistanceEnhanced:
    ...
    def test_basic_1d_vectors(self):
        ...
        from mngs.linalg._distance import euclidean_distance
...
class TestCdistEnhanced:
    ...
    def test_cdist_basic_functionality(self):
        ...
        from mngs.linalg._distance import cdist
    ...
    def test_cdist_scipy_compatibility(self):
        ...
        # Compare with scipy
        mngs_result = cdist(X, Y, metric='euclidean')
        scipy_result = scipy_distance.cdist(X, Y, metric='euclidean')
        
        assert np.allclose(mngs_result, scipy_result)
...
class TestDistanceAliasEnhanced:
    ...
    def test_edist_alias(self):
        ...
        from mngs.linalg._distance import edist, euclidean_distance
    ...
    def test_edist_functionality(self):
        ...
        from mngs.linalg._distance import edist
...
class TestDistanceIntegration:
    ...
    def test_module_imports(self):
        ...
        from mngs.linalg._distance import euclidean_distance, cdist, edist
    ...
    def test_decorator_integration(self):
        """Test integration with MNGS decorators."""
        from mngs.linalg._distance import euclidean_distance
    ...
    def test_scientific_computing_workflow(self):
        ...
        from mngs.linalg._distance import euclidean_distance, cdist
