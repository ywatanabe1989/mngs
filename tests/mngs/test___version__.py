...
# File: ./tests/mngs/test___version__.py
"""Comprehensive tests for mngs.__version__ module."""
...
class TestVersionBasics:
    ...
    def test_version_exists(self):
        ...
        from mngs.__version__ import __version__
    ...
    def test_file_attribute_exists(self):
        ...
        from mngs.__version__ import __FILE__
    ...
    def test_dir_attribute_exists(self):
        ...
        from mngs.__version__ import __DIR__
...
class TestVersionModuleImport:
    ...
    def test_import_from_package(self):
        ...
        assert mngs.__version__ == "1.11.0"
        
    def test_module_attributes(self):
        """Test all expected module attributes."""
        import mngs.__version__ as version_module
...
class TestVersionEdgeCases:
    ...
    def test_version_type_consistency(self):
        ...
        from mngs.__version__ import __version__ as v1
        from mngs.__version__ import __version__ as v2
...
class TestVersionIntegration:
    ...
    def test_version_in_package_metadata(self):
        ...
        try:
            ...
            package_version = importlib.metadata.version('mngs')
...
class TestVersionPerformance:
    ...
    def test_import_speed(self):
        ...
        if 'mngs.__version__' in sys.modules:
            del sys.modules['mngs.__version__']
            
        start = time.time()
        import mngs.__version__
        end = time.time()
...
class TestVersionDocumentation:
    ...
    def test_version_mentioned_in_init(self):
        ...
        from mngs.__version__ import __version__
        assert mngs.__version__ == __version__
