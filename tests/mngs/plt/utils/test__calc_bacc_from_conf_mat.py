...
# File: ./mngs_repo/tests/mngs/plt/utils/test__calc_bacc_from_conf_mat.py
...
class TestCalcBaccFromConfMat:
    ...
    def test_calc_bacc_suppress_output_integration(self):
        ...
        with patch('mngs.plt.utils._calc_bacc_from_conf_mat.suppress_output') as mock_suppress:
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/plt/utils/_calc_bacc_from_conf_mat.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# # EOF
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/plt/utils/_calc_bacc_from_conf_mat.py
# --------------------------------------------------------------------------------
>>>>>>> origin/main
