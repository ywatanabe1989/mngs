#!/usr/bin/env python3
"""Tests for mngs.plt.utils._scientific_captions module.
...
from mngs.plt.utils._scientific_captions import (
    ScientificCaption,
    add_figure_caption,
    add_panel_captions,
    export_captions,
...
class TestCaptionFormatting:
    ...
    def test_latex_escaping(self):
        ...
        """
        from mngs.plt.utils._scientific_captions import _escape_latex
...
class TestIntegration:
    """Test integration with other mngs components."""
    
    @patch('mngs.io.save')
    def test_enhanced_save_integration(self, mock_save):
        """Test integration with mngs.io.save enhancement."""
        from mngs.plt.utils._scientific_captions import enhance_mngs_save_with_captions
        
        # This would normally monkey-patch mngs.io.save
        # For testing, we just verify the function exists and can be called
        assert callable(enhance_mngs_save_with_captions)
