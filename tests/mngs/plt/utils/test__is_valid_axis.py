...
# File: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/tests/mngs/plt/utils/test__is_valid_axis.py
# ----------------------------------------
import os
__FILE__ = (
    "./tests/mngs/plt/utils/test__is_valid_axis.py"
)
...
from mngs.plt.utils import assert_valid_axis, is_valid_axis
...
class TestAxisValidation:
    ...
    def test_mngs_axis_wrapper_is_valid(self):
        """Test that an MNGS AxisWrapper is valid."""
        # Create an MNGS figure and axis
