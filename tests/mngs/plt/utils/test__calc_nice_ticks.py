...
# File: ./mngs_repo/tests/mngs/plt/utils/test__calc_nice_ticks.py
...
class TestCalcNiceTicks:
    ...
    def test_calc_nice_ticks_matplotlib_integration(self):
        ...
        with patch('mngs.plt.utils._calc_nice_ticks.mticker.MaxNLocator') as mock_locator_class:
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/plt/utils/_calc_nice_ticks.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# # EOF
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/plt/utils/_calc_nice_ticks.py
# --------------------------------------------------------------------------------
>>>>>>> origin/main
