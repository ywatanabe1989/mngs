...
# File: ./tests/mngs/plt/test__tpl_comprehensive.py

"""Comprehensive tests for mngs.plt._tpl terminal plotting functionality."""
...
class TestTermplotImport:
    ...
    def test_dependencies_available(self):
        ...
        import mngs.plt._tpl as tpl_module
...
class TestTermplotBasicFunctionality:
    ...
    @patch('mngs.plt._tpl.tpl.figure')
