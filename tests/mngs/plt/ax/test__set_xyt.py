#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Timestamp: "2025-04-28 16:42:17 (ywatanabe)"
# File: /home/ywatanabe/proj/mngs_repo/tests/mngs/plt/ax/test__set_xyt.py
# ----------------------------------------
import os
__FILE__ = (
    "./tests/mngs/plt/ax/test__set_xyt.py"
)
...
from mngs.plt.ax._set_xyt import set_xyt
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /home/ywatanabe/proj/_mngs_repo/src/mngs/plt/ax/_set_xyt.py
# --------------------------------------------------------------------------------
# #!./env/bin/python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: /home/ywatanabe/proj/_mngs_repo/src/mngs/plt/ax/_set_xyt.py
# --------------------------------------------------------------------------------
