...
# File: /home/ywatanabe/proj/mngs_repo/tests/mngs/plt/ax/test___init___enhanced.py
# ----------------------------------------
"""
Enhanced test suite for mngs.plt.ax module initialization and exports.
...
import mngs.plt.ax as ax_module
...
class TestPerformance:
    ...
    def test_import_performance(self, performance_monitor):
        ...
        with performance_monitor.measure('import'):
            ...
            if 'mngs.plt.ax' in sys.modules:
                del sys.modules['mngs.plt.ax']
