#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Timestamp: "2025-04-28 16:41:07 (ywatanabe)"
# File: /home/ywatanabe/proj/mngs_repo/tests/mngs/plt/ax/test__set_size.py
# ----------------------------------------
import os
__FILE__ = (
    "./tests/mngs/plt/ax/test__set_size.py"
)
...
import numpy as np
from mngs.plt.ax._set_size import set_size
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /home/ywatanabe/proj/_mngs_repo/src/mngs/plt/ax/_set_size.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
