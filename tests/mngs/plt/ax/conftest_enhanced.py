...
# File: /home/ywatanabe/proj/mngs_repo/tests/mngs/plt/ax/conftest_enhanced.py
# ----------------------------------------
"""
Enhanced pytest fixtures for mngs.plt.ax module testing.
...
def sample_2d_data():
    ...
    return {
        ...
        'with_pattern': np.outer(np.sin(np.linspace(0, np.pi, 50)), 
...
@pytest.fixture
def mock_save():
    """Mock the mngs.io.save function."""
...
@pytest.fixture
def mngs_modules():
    """Import and provide access to mngs modules if available."""
    modules = {}
