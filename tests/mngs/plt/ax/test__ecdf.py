#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Timestamp: "2025-04-27 19:24:54 (ywatanabe)"
# File: /ssh:sp:/home/ywatanabe/proj/mngs_repo/tests/mngs/plt/ax/test__ecdf.py
# ----------------------------------------
import os
__FILE__ = (
...
# Source code from: /home/ywatanabe/proj/mngs_dev/src/mngs/plt/ax/_ecdf.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
class TestMainFunctionality:
    ...
    def test_with_nan_values(self):
        ...
        assert len(df) == 4  # 6 original values - 2 NaNs
    ...
    def test_with_plot_kwargs(self):
        ...
        for line in self.ax.lines:
            if line.get_linestyle() != "None":  # Skip marker lines
    ...
    def test_step_values(self):
        ...
        expected_steps = (
            2 * len(sorted_data) - 1
        )  # For each point, we need 2 points in the step, minus 1
