...
def test_plot_line_savefig():
    ...
    import numpy as np
    from mngs.plt.ax._plot._plot_statistical_shaded_line import plot_line
...
def test_plot_mean_std_savefig():
    import matplotlib.pyplot as plt
    import numpy as np
    from mngs.plt.ax._plot._plot_statistical_shaded_line import plot_mean_std
...
def test_plot_mean_ci_savefig():
    import matplotlib.pyplot as plt
    import numpy as np
    from mngs.plt.ax._plot._plot_statistical_shaded_line import plot_mean_ci
...
def test_plot_median_iqr_savefig():
    import matplotlib.pyplot as plt
    import numpy as np
    from mngs.plt.ax._plot._plot_statistical_shaded_line import plot_median_iqr
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/plt/ax/_plot/_plot_statistical_shaded_line.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# # EOF
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/plt/ax/_plot/_plot_statistical_shaded_line.py
# --------------------------------------------------------------------------------
