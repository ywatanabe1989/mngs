...
# File: /home/ywatanabe/proj/mngs_repo/tests/mngs/plt/ax/_adjust/test__set_supxyt.py
# ----------------------------------------
import os

__FILE__ = "./tests/mngs/plt/ax/_adjust/test__set_supxyt.py"
...
class TestMainFunctionality:
    ...
    def test_savefig(self):
        ...
        from mngs.plt.ax._style._set_supxyt import set_supxyt
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/plt/ax/_style/_set_supxyt.py
# --------------------------------------------------------------------------------
# #!./env/bin/python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/plt/ax/_style/_set_supxyt.py
# --------------------------------------------------------------------------------
