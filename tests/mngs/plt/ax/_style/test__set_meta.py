#!/usr/bin/env python3
"""Tests for mngs.plt.ax._style._set_meta module.
...
from mngs.plt.ax._style._set_meta import (
    set_meta,
    set_figure_meta,
...
class TestSetMeta:
    ...
    def test_set_meta_basic_caption(self, setup_figure):
        ...
        assert result == ax
        assert hasattr(fig, '_mngs_metadata')
        assert ax in fig._mngs_metadata
        assert fig._mngs_metadata[ax]['caption'] == caption
    ...
    def test_set_meta_all_parameters(self, setup_figure):
        ...
        stored_meta = fig._mngs_metadata[ax]
    ...
    def test_set_meta_keywords_conversion(self, setup_figure):
        ...
        assert fig._mngs_metadata[ax]['keywords'] == ['electrophysiology']
        
        # Multiple keywords as list
        set_meta(ax, keywords=['neural', 'recording'])
        assert fig._mngs_metadata[ax]['keywords'] == ['neural', 'recording']
    ...
    def test_set_meta_automatic_metadata(self, setup_figure):
        ...
        assert 'mngs_version' in stored_meta
    ...
    def test_set_meta_yaml_structure(self, setup_figure):
        ...
        assert hasattr(fig, '_mngs_yaml_metadata')
        assert ax in fig._mngs_yaml_metadata
        assert fig._mngs_yaml_metadata[ax] == fig._mngs_metadata[ax]
    ...
    def test_set_meta_backward_compatibility(self, setup_figure):
        ...
        assert hasattr(fig, '_mngs_captions')
        assert fig._mngs_captions[ax] == caption
    ...
    def test_set_meta_multiple_axes(self, setup_figure):
        ...
        assert len(fig._mngs_metadata) == 2
        assert fig._mngs_metadata[ax1]['caption'] == 'First panel'
        assert fig._mngs_metadata[ax2]['caption'] == 'Second panel'
...
class TestSetFigureMeta:
    ...
    def test_set_figure_meta_basic(self, setup_figure):
        ...
        assert result == ax
        assert hasattr(fig, '_mngs_figure_metadata')
        assert fig._mngs_figure_metadata['main_caption'] == 'Main figure caption'
        assert fig._mngs_figure_metadata['significance'] == 'Important findings'
    ...
    def test_set_figure_meta_all_parameters(self, setup_figure):
        ...
        fig_meta = fig._mngs_figure_metadata
    ...
    def test_set_figure_meta_timestamp(self, setup_figure):
        ...
        assert 'created_timestamp' in fig._mngs_figure_metadata
        timestamp = fig._mngs_figure_metadata['created_timestamp']
        datetime.datetime.fromisoformat(timestamp)  # Should not raise
    ...
    def test_set_figure_meta_backward_compatibility(self, setup_figure):
        ...
        assert hasattr(fig, '_mngs_main_caption')
        assert fig._mngs_main_caption == caption
    ...
    def test_set_figure_meta_from_different_axes(self):
        ...
        assert fig._mngs_figure_metadata['main_caption'] == 'Set from ax3'
...
class TestExportMetadataYaml:
    ...
    def test_export_metadata_yaml_export_info(self, setup_figure_with_metadata):
        ...
        try:
            ...
            assert 'mngs_version' in export_info
...
class TestIntegration:
    ...
    def test_metadata_persistence(self):
        ...
        assert fig._mngs_metadata[ax]['caption'] == 'Test caption'
        assert fig._mngs_metadata[ax]['methods'] == 'Test methods'
    ...
    def test_timestamp_consistency(self):
        ...
        set_meta(ax, caption='Test')
        panel_time = fig._mngs_metadata[ax]['created_timestamp']
        
        set_figure_meta(ax, caption='Figure test')
        figure_time = fig._mngs_figure_metadata['created_timestamp']
