#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Timestamp: "2025-05-03 12:36:06 (ywatanabe)"
# File: /home/ywatanabe/proj/mngs_repo/tests/mngs/plt/ax/_style/test__add_panel.py
# ----------------------------------------
import os
__FILE__ = (
    "./tests/mngs/plt/ax/_style/test__add_panel.py"
)
