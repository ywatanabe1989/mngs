...
# File: /home/ywatanabe/proj/mngs_repo/tests/mngs/plt/ax/_adjust/test__set_xyt.py
# ----------------------------------------
import os

__FILE__ = "./tests/mngs/plt/ax/_adjust/test__set_xyt.py"
__DIR__ = os.path.dirname(__FILE__)
# ----------------------------------------

import matplotlib
import matplotlib.pyplot as plt
from mngs.plt.ax._style._set_xyt import set_xyt
...
class TestMainFunctionality:
    ...
    #     with patch(
    #         "mngs.plt.ax._format_label.format_label",
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/plt/ax/_style/_set_xyt.py
# --------------------------------------------------------------------------------
# #!./env/bin/python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/plt/ax/_style/_set_xyt.py
# --------------------------------------------------------------------------------
