...
def test_constrained_layout_default():
    """Test that mngs.plt.subplots uses constrained_layout by default."""
    import mngs.plt as plt
...
def test_tight_layout_compatibility():
    """Test that mngs.plt.tight_layout behaves like matplotlib.pyplot.tight_layout."""
...
def test_matplotlib_pyplot_tight_layout_patched():
    """Test that matplotlib.pyplot.tight_layout is patched when mngs.plt is imported."""
    import mngs.plt  # This should patch matplotlib.pyplot.tight_layout
    import matplotlib.pyplot as plt
    import warnings
    
    # Create figure with mngs.plt but use matplotlib.pyplot for everything else
    fig, axes = mngs.plt.subplots(2, 2, figsize=(8, 6))
    data = np.random.randn(10, 10)
