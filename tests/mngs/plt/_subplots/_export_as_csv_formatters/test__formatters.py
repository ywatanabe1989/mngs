...
# File: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/tests/mngs/plt/_subplots/_export_as_csv_formatters/test__formatters.py
# ----------------------------------------
import os
__FILE__ = (
    "./tests/mngs/plt/_subplots/_export_as_csv_formatters/test__formatters.py"
)
...
from mngs.plt._subplots._export_as_csv_formatters import (
    _format_plot_kde,
    _format_plot_line,
