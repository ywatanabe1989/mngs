...
# File: ./tests/mngs/plt/_subplots/test__AxisWrapper_auto_tracking.py
...
def test_auto_tracking_without_explicit_id():
    ...
    fig, ax = mngs.plt.subplots(track=True)
...
def test_save_with_csv_export():
    """Test that mngs.io.save exports CSV with plotting history."""
    import mngs
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        mngs.io.save(fig, png_path, verbose=False)
