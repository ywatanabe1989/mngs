...
# File: ./tests/mngs/plt/_subplots/test__AxesWrapper_setitem.py
...
def test_axes_wrapper_item_assignment():
    ...
    # Create subplots using mngs
    fig, axes = mngs.plt.subplots(3, 2, figsize=(8, 6))
...
def test_axes_wrapper_assignment_with_slicing():
    ...
    fig, axes = mngs.plt.subplots(3, 3, figsize=(9, 9))
...
def test_axes_wrapper_assignment_edge_cases():
    ...
    fig, axes = mngs.plt.subplots(2, 1, figsize=(6, 8))
