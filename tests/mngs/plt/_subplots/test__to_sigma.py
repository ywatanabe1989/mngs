#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Timestamp: "2025-04-28 16:50:41 (ywatanabe)"
# File: /home/ywatanabe/proj/mngs_repo/tests/mngs/plt/_subplots/test__to_sigma.py
# ----------------------------------------
import os
__FILE__ = (
...
import numpy as np
import pandas as pd
from mngs.plt._subplots._to_sigma import format_plotting_args, to_sigma


class TestToSigma:
    def test_empty_history(self):
        history = {}
        result = to_sigma(history)
...
class TestFormatPlottingArgs:
    def test_plot_with_single_array(self):
        ...
        result = format_plotting_args(record)
        assert isinstance(result, pd.DataFrame)
        assert "plot1_plot_x" in result.columns
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /home/ywatanabe/proj/_mngs_repo/src/mngs/plt/_subplots/_to_sigma.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: /home/ywatanabe/proj/_mngs_repo/src/mngs/plt/_subplots/_to_sigma.py
# --------------------------------------------------------------------------------
