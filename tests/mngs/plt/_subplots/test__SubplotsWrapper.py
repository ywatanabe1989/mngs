...
# File: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/tests/mngs/plt/_subplots/test__SubplotsWrapper.py
...
class TestSubplotsWrapper:
    """Test cases for mngs.plt.subplots wrapper functionality."""
    ...
    def test_1d_array_single_row(self):
        ...
        fig, axes = mngs.plt.subplots(1, 3)
    ...
    def test_1d_array_single_column(self):
        ...
        fig, axes = mngs.plt.subplots(3, 1)
        assert hasattr(axes, "__len__"), "Should return array-like object"
        assert len(axes) == 3, "Should have 3 axes"
        # Test individual axis access
        for i in range(3):
    ...
    def test_matplotlib_compatibility(self):
        ...
        mngs_fig, mngs_axes = mngs.plt.subplots(3, 2)

        # Both should have the same shape
        assert mngs_axes.shape == mpl_axes.shape, "Should have same shape as matplotlib"
        ...
        for i in range(3):
            for j in range(2):
                ...
                mpl_ax = mpl_axes[i, j]
                mngs_ax = mngs_axes[i, j]
                assert hasattr(mngs_ax, "plot"), "mngs axis should have plot method"
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/plt/_subplots/_SubplotsWrapper.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# 
#         # Wrap the figure
#         self._fig_mngs = FigWrapper(self._fig_mpl)
# 
...
#             return self._fig_mngs, self._axis_mngs
# 
#         # Handle multiple axes case
#         axes_flat_mpl = axes_array_mpl.ravel()
#         axes_flat_mngs_list = [
#             AxisWrapper(self._fig_mngs, ax_, track) for ax_ in axes_flat_mpl
#         ]
# 
#         # Reshape the axes_flat_mngs_list axes to match the original layout
#         axes_array_mngs = np.array(axes_flat_mngs_list).reshape(axes_shape_mpl)
# 
...
# from mngs.plt import subplots as msubplots
...
# # EOF
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/plt/_subplots/_SubplotsWrapper.py
# --------------------------------------------------------------------------------
>>>>>>> origin/main
