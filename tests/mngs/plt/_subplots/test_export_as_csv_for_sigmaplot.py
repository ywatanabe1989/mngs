...
# Author: ywatanabe
# File: /data/gpfs/projects/punim2354/ywatanabe/.claude-worktree/mngs_repo/tests/mngs/plt/_subplots/test_export_as_csv_for_sigmaplot.py
...
def test_integration_with_io_save_dataframe():
    """Test that exported dataframe can be saved with mngs.io.save."""
    import tempfile
    import os
...
def test_automatic_sigmaplot_export_on_figure_save():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        mngs.io.save(fig, img_path, verbose=True)
...
def test_figure_without_export_method():
    ...
    # Create regular matplotlib figure (not mngs wrapped)
    fig, ax = plt.subplots()
    ax.plot([1, 2, 3], [4, 5, 6])
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        mngs.io.save(fig, img_path, verbose=False)
