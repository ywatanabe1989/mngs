#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Timestamp: "2025-04-28 16:50:09 (ywatanabe)"
...
from mngs.plt._subplots._SubplotsManager import SubplotsManager, subplots


class TestSubplotsManager:
    def setup_method(self):
        self.manager = SubplotsManager()
