...
# File: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/tests/mngs/plt/_subplots/_AxisWrapperMixins/test_export_to_csv.py
# ----------------------------------------
import os
__FILE__ = (
    "./tests/mngs/plt/_subplots/_AxisWrapperMixins/test_export_to_csv.py"
)
...
def test_track_parameter_controls_csv_export():
    ...
    mngs.io.save(fig1, spath1, symlink_from_cwd=False)
    ...
    mngs.io.save(fig2, spath2, symlink_from_cwd=False)
