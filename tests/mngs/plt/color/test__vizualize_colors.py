...
__FILE__ = "./tests/mngs/plt/color/test__vizualize_colors.py"
...
def test_vizualize_colors_invalid_rgba_values():
    ...
    # Should handle invalid values (matplotlib will clamp them)
    fig, ax = vizualize_colors(test_colors)
    assert isinstance(fig, plt.Figure)
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/plt/color/_vizualize_colors.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# # EOF
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/plt/color/_vizualize_colors.py
# --------------------------------------------------------------------------------
