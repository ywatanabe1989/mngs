...
__FILE__ = "./tests/mngs/plt/color/test__interpolate.py"
...
def test_gen_interpolate_basic():
    ...
    from mngs.plt.color._interpolate import gen_interpolate
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/plt/color/_interpolate.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# # EOF
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/plt/color/_interpolate.py
# --------------------------------------------------------------------------------
