...
class TestModuleStructure:
    ...
    def test_module_imports(self):
        ...
        assert mngs.plt.color is not None
    
    def test_file_and_dir_attributes(self):
        """Test __FILE__ and __DIR__ attributes."""
        import mngs.plt.color
        
        assert hasattr(mngs.plt.color, '__FILE__')
        assert hasattr(mngs.plt.color, '__DIR__')
        assert mngs.plt.color.__FILE__ == "./src/mngs/plt/color/__init__.py"
    ...
    def test_all_imports_available(self):
        ...
        # Colormap functions
        assert hasattr(mngs.plt.color, 'get_color_from_cmap')
        assert hasattr(mngs.plt.color, 'get_colors_from_cmap')
        assert hasattr(mngs.plt.color, 'get_categorical_colors_from_cmap')
        
        # Other utilities
        assert hasattr(mngs.plt.color, 'interpolate')
        assert hasattr(mngs.plt.color, 'PARAMS')
        assert hasattr(mngs.plt.color, 'vizualize_colors')
        
        # RGB functions
        assert hasattr(mngs.plt.color, 'str2rgb')
        assert hasattr(mngs.plt.color, 'str2rgba')
        assert hasattr(mngs.plt.color, 'rgb2rgba')
        assert hasattr(mngs.plt.color, 'rgba2rgb')
        assert hasattr(mngs.plt.color, 'rgba2hex')
        assert hasattr(mngs.plt.color, 'cycle_color_rgb')
        assert hasattr(mngs.plt.color, 'gradiate_color_rgb')
        assert hasattr(mngs.plt.color, 'gradiate_color_rgba')
        
        # BGR functions
        assert hasattr(mngs.plt.color, 'str2bgr')
        assert hasattr(mngs.plt.color, 'str2bgra')
        assert hasattr(mngs.plt.color, 'bgr2bgra')
        assert hasattr(mngs.plt.color, 'bgra2bgr')
        assert hasattr(mngs.plt.color, 'bgra2hex')
        assert hasattr(mngs.plt.color, 'cycle_color_bgr')
        assert hasattr(mngs.plt.color, 'gradiate_color_bgr')
        assert hasattr(mngs.plt.color, 'gradiate_color_bgra')
        
        # Common functions
        assert hasattr(mngs.plt.color, 'rgb2bgr')
        assert hasattr(mngs.plt.color, 'bgr2rgb')
        assert hasattr(mngs.plt.color, 'str2hex')
        assert hasattr(mngs.plt.color, 'update_alpha')
        assert hasattr(mngs.plt.color, 'cycle_color')
        assert hasattr(mngs.plt.color, 'gradiate_color')
        assert hasattr(mngs.plt.color, 'to_rgb')
        assert hasattr(mngs.plt.color, 'to_rgba')
        assert hasattr(mngs.plt.color, 'to_hex')
...
class TestColorConversions:
    ...
    def test_str2rgb(self):
        ...
        red = mngs.plt.color.str2rgb('red')
    ...
    def test_str2rgba(self):
        ...
        blue = mngs.plt.color.str2rgba('blue')
    ...
    def test_rgb2rgba(self):
        ...
        rgb = [1.0, 0.5, 0.0]
        rgba = mngs.plt.color.rgb2rgba(rgb)
    ...
    def test_rgba2rgb(self):
        ...
        rgb = mngs.plt.color.rgba2rgb(rgba)
    ...
    def test_rgba2hex(self):
        ...
        hex_color = mngs.plt.color.rgba2hex(rgba)
    ...
    def test_str2hex(self):
        ...
        hex_green = mngs.plt.color.str2hex('green')
    ...
    def test_rgb2bgr(self):
        ...
        rgb = [1.0, 0.5, 0.0]
        bgr = mngs.plt.color.rgb2bgr(rgb)
    ...
    def test_bgr2rgb(self):
        ...
        bgr = [0.0, 0.5, 1.0]
        rgb = mngs.plt.color.bgr2rgb(bgr)
    ...
    def test_to_rgb(self):
        ...
        # From string
        rgb1 = mngs.plt.color.to_rgb('red')
        assert len(rgb1) == 3
        
        # From hex
        rgb2 = mngs.plt.color.to_rgb('#FF0000')
        assert len(rgb2) == 3
        
        # From rgba
        rgb3 = mngs.plt.color.to_rgb([1, 0, 0, 1])
        assert len(rgb3) == 3
    ...
    def test_to_rgba(self):
        ...
        # From string
        rgba1 = mngs.plt.color.to_rgba('blue')
        assert len(rgba1) == 4
        
        # From rgb
        rgba2 = mngs.plt.color.to_rgba([0, 0, 1])
        assert len(rgba2) == 4
    ...
    def test_to_hex(self):
        ...
        # From string
        hex1 = mngs.plt.color.to_hex('green')
        assert hex1.startswith('#')
        
        # From rgb
        hex2 = mngs.plt.color.to_hex([0, 1, 0])
...
class TestColorManipulation:
    ...
    def test_update_alpha(self):
        ...
        new_rgba = mngs.plt.color.update_alpha(rgba, 0.5)
    ...
    def test_cycle_color(self):
        ...
        # Get cycled colors
        colors = [mngs.plt.color.cycle_color(i) for i in range(10)]
        ...
        color1 = mngs.plt.color.cycle_color(0)
        color2 = mngs.plt.color.cycle_color(cycle_length)
    ...
    def test_gradiate_color(self):
        ...
        for i in range(n_colors):
            t = i / (n_colors - 1)
            color = mngs.plt.color.gradiate_color('red', 'blue', t)
            colors.append(color)
    ...
    def test_cycle_color_rgb(self):
        ...
        colors = [mngs.plt.color.cycle_color_rgb(i) for i in range(5)]
    ...
    def test_gradiate_color_rgb(self):
        ...
        # Midpoint
        mid_color = mngs.plt.color.gradiate_color_rgb(color1, color2, 0.5)
...
class TestColormapFunctions:
    ...
    def test_get_color_from_cmap(self):
        ...
        color = mngs.plt.color.get_color_from_cmap(0.5, 'viridis')
    ...
    def test_get_colors_from_cmap(self):
        ...
        n_colors = 10
        colors = mngs.plt.color.get_colors_from_cmap(n_colors, 'plasma')
    ...
    def test_get_categorical_colors_from_cmap(self):
        ...
        n_categories = 5
        colors = mngs.plt.color.get_categorical_colors_from_cmap(n_categories, 'tab10')
...
class TestColorInterpolation:
    ...
    def test_interpolate_basic(self):
        ...
        interp_0 = mngs.plt.color.interpolate(color1, color2, 0)
        interp_1 = mngs.plt.color.interpolate(color1, color2, 1)
        interp_half = mngs.plt.color.interpolate(color1, color2, 0.5)
    ...
    def test_interpolate_with_alpha(self):
        ...
        interp = mngs.plt.color.interpolate(color1, color2, 0.5)
        assert len(interp) == 4
...
class TestPARAMS:
    ...
    def test_params_exists(self):
        ...
        assert hasattr(mngs.plt.color, 'PARAMS')
        assert mngs.plt.color.PARAMS is not None
    
    def test_params_structure(self):
        """Test PARAMS structure if it's a dict."""
        import mngs.plt.color
        
        params = mngs.plt.color.PARAMS
...
class TestVisualization:
    ...
    def test_vizualize_colors_function_exists(self):
        ...
        assert hasattr(mngs.plt.color, 'vizualize_colors')
        assert callable(mngs.plt.color.vizualize_colors)
    ...
    def test_vizualize_colors_basic(self, mock_show):
        ...
        result = mngs.plt.color.vizualize_colors(colors)
...
class TestBGRFunctions:
    ...
    def test_str2bgr(self):
        ...
        bgr = mngs.plt.color.str2bgr('red')
        assert len(bgr) == 3
    ...
    def test_bgr2bgra(self):
        ...
        bgr = [0, 0.5, 1]
        bgra = mngs.plt.color.bgr2bgra(bgr)
    ...
    def test_bgra2bgr(self):
        ...
        bgra = [0, 0.5, 1, 0.8]
        bgr = mngs.plt.color.bgra2bgr(bgra)
    ...
    def test_cycle_color_bgr(self):
        ...
        colors = [mngs.plt.color.cycle_color_bgr(i) for i in range(5)]
        assert all(len(c) == 3 for c in colors)
...
class TestEdgeCases:
    ...
    def test_invalid_color_string(self):
        ...
        try:
            color = mngs.plt.color.str2rgb('not_a_color')
    ...
    def test_empty_color_list(self):
        ...
        colors = mngs.plt.color.get_colors_from_cmap(0, 'viridis')
        assert len(colors) == 0
    ...
    def test_single_color_gradient(self):
        ...
        color = [0.5, 0.5, 0.5]
        result = mngs.plt.color.gradiate_color_rgb(color, color, 0.5)
...
class TestIntegration:
    ...
    def test_full_color_pipeline(self):
        ...
        # Convert to RGB
        rgb = mngs.plt.color.str2rgb(color_str)
    ...
    def test_colormap_to_hex(self):
        ...
        colors = mngs.plt.color.get_colors_from_cmap(5, 'viridis')
        
        # Convert all to hex
        hex_colors = [mngs.plt.color.to_hex(c) for c in colors]
    ...
    def test_color_manipulation_pipeline(self):
        ...
        base_color = mngs.plt.color.str2rgba('blue')
        
        # Update alpha
        transparent = mngs.plt.color.update_alpha(base_color, 0.5)
        assert transparent[3] == 0.5
        
        # Create gradient to another color
        target_color = mngs.plt.color.str2rgba('green')
        mid_color = mngs.plt.color.gradiate_color_rgba(
...
class TestImportOrder:
    ...
    def test_import_after_usage(self):
        ...
        import mngs.plt.color
        from mngs.plt.color import str2rgb, rgb2rgba
    ...
    def test_submodule_imports(self):
        ...
        assert mngs.plt.color.__name__ == 'mngs.plt.color'
        
        # Functions should be at module level
        assert 'str2rgb' in dir(mngs.plt.color)
        assert 'get_colors_from_cmap' in dir(mngs.plt.color)
