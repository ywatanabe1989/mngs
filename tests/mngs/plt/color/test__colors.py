...
# File: /home/ywatanabe/proj/mngs_repo/tests/mngs/plt/color/test__colors.py
# ----------------------------------------
import os
__FILE__ = (
    "./tests/mngs/plt/color/test__colors.py"
)
...
from mngs.plt.color._colors import (bgr2bgra, bgr2rgb, bgra2bgr, bgra2hex,
                                    bgra2rgba, cycle_color, cycle_color_bgr,
                                    cycle_color_rgb, gradiate_color_bgr,
                                    gradiate_color_bgra, gradiate_color_rgb,
                                    gradiate_color_rgba, rgb2bgr, rgb2rgba,
                                    rgba2bgra, rgba2hex, rgba2rgb, str2bgr,
                                    str2bgra, str2hex, str2rgb, str2rgba,
                                    update_alpha)
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/plt/color/_colors.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# # EOF
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/plt/color/_colors.py
# --------------------------------------------------------------------------------
