...
from mngs.gen._tee import Tee, tee
...
class TestTeeClass:
    ...
    def test_tee_failed_file_open(self):
        ...
        with patch("mngs.gen._tee.printc") as mock_printc:
...
class TestMainAlias:
    ...
    def test_main_is_tee(self):
        ...
        from mngs.gen._tee import main, tee
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/gen/_tee.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# # EOF
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/gen/_tee.py
# --------------------------------------------------------------------------------
