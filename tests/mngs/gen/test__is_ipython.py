#!/usr/bin/env python3
"""Tests for mngs.gen._is_ipython module."""

import pytest
from unittest.mock import patch, MagicMock
from mngs.gen._is_ipython import is_ipython, is_script
...
class TestIsIPython:
    ...
    def test_is_ipython_in_ipython(self):
        ...
        import mngs.gen._is_ipython

        # Save original function
        original_is_ipython = mngs.gen._is_ipython.is_ipython
        ...
        mngs.gen._is_ipython.is_ipython = mock_is_ipython

        try:
            assert mngs.gen._is_ipython.is_ipython() is True
        finally:
            # Restore original function
            mngs.gen._is_ipython.is_ipython = original_is_ipython
...
class TestIsScript:
    ...
    def test_is_script_with_mocked_ipython(self):
        ...
        original_is_ipython = mngs.gen._is_ipython.is_ipython
        original_is_script = mngs.gen._is_ipython.is_script

        # Mock is_ipython to return True
        mngs.gen._is_ipython.is_ipython = lambda: True

        # Redefine is_script to use the mocked is_ipython
        mngs.gen._is_ipython.is_script = lambda: not mngs.gen._is_ipython.is_ipython()

        try:
            assert mngs.gen._is_ipython.is_script() is False
        finally:
            # Restore original functions
            mngs.gen._is_ipython.is_ipython = original_is_ipython
            mngs.gen._is_ipython.is_script = original_is_script
...
class TestIntegration:
    ...
    def test_environment_detection(self, mock_ipython):
        ...
        # Mock the function
        mngs.gen._is_ipython.is_ipython = lambda: mock_ipython
        ...
        try:
            if mock_ipython:
                ...
                assert mngs.gen._is_ipython.is_ipython() is False
                assert mngs.gen._is_ipython.is_script() is True
        finally:
            # Restore
            mngs.gen._is_ipython.is_ipython = original_is_ipython
