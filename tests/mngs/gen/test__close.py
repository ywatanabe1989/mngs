#!/usr/bin/env python3
"""Tests for mngs.gen._close module."""
...
class TestProcessTimestamp:
    ...
    def test_process_timestamp_basic(self):
        ...
        with patch("mngs.gen._close.datetime") as mock_datetime:
...
class TestSaveConfigs:
    ...
    @patch("mngs.gen._close.mngs_io_save")
...
class TestClose:
    ...
    @patch("mngs.gen._close._process_timestamp")
    @patch("mngs.gen._close._save_configs")
    @patch("mngs.gen._close.running2finished")
    ...
    @patch("mngs.gen._close.mngs_utils_notify")
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/gen/_close.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# # EOF
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/gen/_close.py
# --------------------------------------------------------------------------------
