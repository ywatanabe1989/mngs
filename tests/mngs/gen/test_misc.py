...
class TestIsLaterOrEqual:
    ...
    @pytest.mark.skip(reason="Requires mngs.gen.search which may not be available")
    def test_version_comparison(self):
        """Test version comparison functionality."""
        # This test would require mocking or the actual mngs.gen.search function
        pass
...
class TestFileCopying:
    ...
    def test_copy_to_directory(self, tmp_path):
        ...
        # Note: Function seems to have a bug - it needs mngs.path.split
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/gen/misc.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/gen/misc.py
# --------------------------------------------------------------------------------
