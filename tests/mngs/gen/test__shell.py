#!/usr/bin/env python3
"""Tests for mngs.gen._shell module."""
...
from mngs.gen._shell import run_shellscript, run_shellcommand
...
class TestRunShellScript:
    ...
    @patch("mngs.gen._shell.run_shellcommand")
    @patch("subprocess.run")
    @patch("os.access")
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/gen/_shell.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/gen/_shell.py
# --------------------------------------------------------------------------------
>>>>>>> origin/main
