...
# File: ./mngs_repo/tests/mngs/str/test__print_debug.py
...
class TestPrintDebugBasic:
    ...
    def test_print_debug_basic(self, capsys):
        ...
        from mngs.str._print_debug import print_debug
...
class TestPrintDebugIntegration:
    ...
    @patch('mngs.str._print_debug.printc')
...
class TestPrintDebugConstants:
    ...
    def test_this_file_constant(self):
        ...
        from mngs.str._print_debug import THIS_FILE
    ...
    def test_printc_import(self):
        ...
        from mngs.str._print_debug import printc
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/str/_print_debug.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/str/_print_debug.py
# --------------------------------------------------------------------------------
>>>>>>> origin/main
