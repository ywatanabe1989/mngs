...
# File: ./mngs_repo/tests/mngs/str/test__color_text.py
...
class TestColorTextBasic:
    ...
    def test_color_text_default(self):
        ...
        from mngs.str._color_text import color_text
...
class TestColorTextCtAlias:
    ...
    def test_ct_is_alias(self):
        ...
        from mngs.str._color_text import ct, color_text
    ...
    def test_ct_with_defaults(self):
        ...
        from mngs.str._color_text import ct
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/str/_color_text.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/str/_color_text.py
# --------------------------------------------------------------------------------
>>>>>>> origin/main
