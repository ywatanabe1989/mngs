...
# File: ./tests/mngs/str/test__latex_fallback.py
...
import functools
from mngs.str._latex_fallback import (
    set_fallback_mode,
    get_fallback_mode,
...
class TestSafeLatexRender:
    ...
    @patch('mngs.str._latex_fallback.check_latex_capability', return_value=True)
