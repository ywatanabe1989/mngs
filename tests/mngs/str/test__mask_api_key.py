...
# File: ./mngs_repo/tests/mngs/str/test__mask_api_key.py
...
class TestMaskApiKeyBasic:
    ...
    def test_mask_api_basic(self):
        ...
        from mngs.str._mask_api_key import mask_api
...
class TestMaskApiKeyComparison:
    ...
    def test_equivalent_to_parameterized_n4(self):
        ...
        from mngs.str._mask_api_key import mask_api as mask_api_fixed
        from mngs.str._mask_api import mask_api as mask_api_param
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/str/_mask_api_key.py
# --------------------------------------------------------------------------------
# #!./env/bin/python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/str/_mask_api_key.py
# --------------------------------------------------------------------------------
>>>>>>> origin/main
