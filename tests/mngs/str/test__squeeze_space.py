...
# File: ./mngs_repo/tests/mngs/str/test__squeeze_space.py
...
class TestSqueezeSpacesBasic:
    ...
    def test_squeeze_spaces_default_behavior(self):
        ...
        from mngs.str._squeeze_space import squeeze_spaces
...
class TestSqueezeSpacesRegexIntegration:
    ...
    @patch('mngs.str._squeeze_space.re')
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/str/_squeeze_space.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/str/_squeeze_space.py
# --------------------------------------------------------------------------------
>>>>>>> origin/main
