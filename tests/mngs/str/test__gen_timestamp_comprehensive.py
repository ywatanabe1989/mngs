...
# File: ./mngs_repo/tests/mngs/str/test__gen_timestamp_comprehensive.py
...
class TestGenTimestampBasic:
    ...
    def test_timestamp_alias(self):
        ...
        from mngs.str._gen_timestamp import gen_timestamp, timestamp
...
class TestGenTimestampUsagePatterns:
    ...
    def test_sorting_compatibility(self):
        ...
        with patch('mngs.str._gen_timestamp._datetime') as mock_dt:
            timestamps = []
