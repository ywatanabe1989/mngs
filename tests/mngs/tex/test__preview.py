...
# File: ./mngs_repo/tests/mngs/tex/test__preview.py
...
class TestPreview:
    ...
    def test_preview_single_tex_string(self):
        ...
        from mngs.tex._preview import preview
    ...
    def test_preview_with_actual_matplotlib(self):
        ...
        # Skip this test as mngs.plt.subplots returns wrapped objects
        # that don't directly expose matplotlib Figure interface
        pytest.skip("mngs.plt.subplots returns wrapped objects, not raw matplotlib figures")
...
=======
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/tex/_preview.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/tex/_preview.py
# --------------------------------------------------------------------------------
>>>>>>> origin/main
