...
# File: ./mngs_repo/tests/mngs/dsp/test__pac.py

import pytest
import numpy as np
import torch
import unittest.mock as mock
from mngs.dsp._pac import pac
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/dsp/_pac.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# 
# THIS_FILE = "/home/ywatanabe/proj/mngs_repo/src/mngs/dsp/_pac.py"
# 
# import sys
# 
...
# #             assert np.allclose(
# #                 pha_mids_mngs, _pha_mids_tp
# #             )
# #             assert np.allclose(
# #                 amp_mids_mngs, _amp_mids_tp
# #             )
# 
# #             mngs.io.save(
...
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/dsp/_pac.py
# --------------------------------------------------------------------------------
>>>>>>> origin/main
