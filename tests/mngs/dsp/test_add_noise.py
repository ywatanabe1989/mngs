...
# File: ./tests/mngs/dsp/test_add_noise.py

"""
Test module for mngs.dsp.add_noise functions.
"""
...
class TestAddNoise:
    ...
    def test_module_import(self):
        ...
        import mngs.dsp.add_noise

        assert hasattr(mngs.dsp.add_noise, "gauss")
        assert hasattr(mngs.dsp.add_noise, "white")
        assert hasattr(mngs.dsp.add_noise, "pink")
        assert hasattr(mngs.dsp.add_noise, "brown")

    def test_gauss_noise(self, clean_signal):
        """Test Gaussian noise addition."""
        from mngs.dsp.add_noise import gauss
    ...
    def test_white_noise(self, clean_signal):
        ...
        from mngs.dsp.add_noise import white
    ...
    def test_pink_noise(self, clean_signal):
        ...
        from mngs.dsp.add_noise import pink
    ...
    def test_brown_noise(self, clean_signal):
        ...
        from mngs.dsp.add_noise import brown
    ...
    def test_multi_channel_noise(self, multi_channel_signal):
        ...
        from mngs.dsp.add_noise import gauss, white, pink, brown
    ...
    def test_zero_amplitude(self, clean_signal):
        ...
        from mngs.dsp.add_noise import gauss, white
    ...
    def test_different_dimensions(self):
        ...
        from mngs.dsp.add_noise import gauss, pink, brown
    ...
    def test_signal_to_noise_ratio(self, clean_signal, noise_type, amp):
        ...
        import mngs.dsp.add_noise as add_noise
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/dsp/add_noise.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/dsp/add_noise.py
# --------------------------------------------------------------------------------
