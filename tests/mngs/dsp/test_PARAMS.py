...
class TestBands:
    ...
    def test_import(self):
        ...
        assert hasattr(mngs.dsp.params, "BANDS")
...
class TestEEGMontage1020:
    ...
    def test_import(self):
        ...
        assert hasattr(mngs.dsp.params, "EEG_MONTAGE_1020")

    def test_montage_structure(self):
        """Test EEG_MONTAGE_1020 is a list of strings."""
        montage = mngs.dsp.params.EEG_MONTAGE_1020
...
class TestEEGMontageBipolarTransverse:
    ...
    def test_import(self):
        ...
        assert hasattr(mngs.dsp.params, "EEG_MONTAGE_BIPOLAR_TRANVERSE")

    def test_montage_structure(self):
        """Test bipolar montage is a list of strings."""
        montage = mngs.dsp.params.EEG_MONTAGE_BIPOLAR_TRANVERSE
    ...
    def test_channel_consistency(self):
        ...
        montage = mngs.dsp.params.EEG_MONTAGE_BIPOLAR_TRANVERSE
        standard = mngs.dsp.params.EEG_MONTAGE_1020
