...
# File: ./tests/mngs/dsp/test_filt.py

"""
Test module for mngs.dsp.filt filtering functions.
"""
...
class TestFilt:
    ...
    def test_module_import(self):
        ...
        import mngs.dsp.filt

        assert hasattr(mngs.dsp.filt, "bandpass")
        assert hasattr(mngs.dsp.filt, "bandstop")
    ...
    def test_bandpass_filter(self, simple_signal):
        ...
        from mngs.dsp.filt import bandpass
    ...
    def test_bandstop_filter(self, simple_signal):
        ...
        from mngs.dsp.filt import bandstop
    ...
    def test_lowpass_filter(self, simple_signal):
        ...
        from mngs.dsp.filt import lowpass
    ...
    def test_highpass_filter(self, simple_signal):
        ...
        from mngs.dsp.filt import highpass
    ...
    def test_gaussian_filter(self, simple_signal):
        ...
        from mngs.dsp.filt import gauss
    ...
    def test_edge_frequencies(self, simple_signal):
        ...
        from mngs.dsp.filt import lowpass, highpass
    ...
    def test_filter_stability(self, simple_signal):
        ...
        from mngs.dsp.filt import bandpass, lowpass, highpass
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /home/ywatanabe/proj/_mngs_repo/src/mngs/dsp/filt.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: /home/ywatanabe/proj/_mngs_repo/src/mngs/dsp/filt.py
# --------------------------------------------------------------------------------
