...
# File: ./mngs_repo/tests/mngs/dsp/test__detect_ripples.py
...
from mngs.dsp._detect_ripples import (
    detect_ripples,
    _preprocess,
    _find_events,
...
class TestPreprocessing:
    ...
    def test_preprocess_filtering(self):
        ...
        from mngs.dsp._demo_sig import demo_sig
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/dsp/_detect_ripples.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/dsp/_detect_ripples.py
# --------------------------------------------------------------------------------
>>>>>>> origin/main
