...
# File: ./tests/mngs/context/test__suppress_output.py
# ----------------------------------------

"""
Comprehensive test suite for mngs.context._suppress_output module.
...
from src.mngs.context._suppress_output import suppress_output, quiet
