...
# File: ./mngs_repo/tests/mngs/context/test___init__.py
...
class TestContextInit:
    ...
    def test_quiet_alias(self):
        ...
        from mngs.context._suppress_output import quiet, suppress_output
    ...
    def test_suppress_output_import_via_quiet(self):
        ...
        from mngs.context._suppress_output import quiet
    ...
    def test_module_structure_integrity(self):
        ...
        # Check module name
        assert mngs.context.__name__ == 'mngs.context'
        
        # Check that suppress_output is available
        assert hasattr(mngs.context, 'suppress_output')
        
        # Verify it's the same function as imported directly
        from mngs.context._suppress_output import suppress_output as direct_import
        assert mngs.context.suppress_output is direct_import
