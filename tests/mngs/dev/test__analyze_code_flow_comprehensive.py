...
# File: ./mngs_repo/tests/mngs/dev/test__analyze_code_flow_comprehensive.py
...
class TestCodeFlowAnalyzerBasic:
    ...
    def test_import(self):
        ...
        from mngs.dev._analyze_code_flow import CodeFlowAnalyzer, analyze_code_flow
        assert callable(CodeFlowAnalyzer)
        assert callable(analyze_code_flow)
    
    def test_initialization(self):
        """Test CodeFlowAnalyzer initialization."""
        from mngs.dev._analyze_code_flow import CodeFlowAnalyzer
...
class TestAnalyzeCodeFlowFunction:
    ...
    def test_analyze_code_flow_wrapper(self):
        ...
        from mngs.dev._analyze_code_flow import analyze_code_flow
    ...
    @patch('mngs.dev._analyze_code_flow.CodeFlowAnalyzer')
...
class TestCodeFlowAnalyzerIntegration:
    ...
    @patch('mngs.dev._analyze_code_flow.__file__', '/test/file.py')
    @patch('builtins.print')
    def test_main_function(self, mock_print):
        """Test main function execution."""
        from mngs.dev._analyze_code_flow import main
        
        # Create mock args
        args = MagicMock()
        
        with patch('mngs.dev._analyze_code_flow.analyze_code_flow') as mock_analyze:
    ...
    def test_parse_args(self):
        ...
        from mngs.dev._analyze_code_flow import parse_args
        
        with patch('sys.argv', ['script.py', '--var', '5', '--flag']):
            with patch('mngs.str.printc'):  # Mock the print function
                args = parse_args()
