...
# File: ./tests/mngs/path/test__get_spath.py
...
def test_get_spath_default():
    ...
    from mngs.path._get_spath import get_spath
    
    with patch('mngs.path._get_spath.split') as mock_split:
        with patch('inspect.stack') as mock_stack:
            ...
            with patch('mngs.path._get_spath.__file__', '/test/path/module.py'):
                result = get_spath()
    ...
    with patch('mngs.path._get_spath.split') as mock_split:
        with patch('inspect.stack') as mock_stack:
            with patch('os.makedirs') as mock_makedirs:
                ...
                with patch('mngs.path._get_spath.__file__', '/test/module.py'):
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        with patch('mngs.path._get_spath.split') as mock_split:
            with patch('inspect.stack') as mock_stack:
                ...
                with patch('mngs.path._get_spath.__file__', test_file):
    ...
    with patch('mngs.path._get_spath.split') as mock_split:
        with patch('inspect.stack') as mock_stack:
            with patch.dict(os.environ, {'USER': 'testuser'}):
                ...
                with patch('mngs.path._get_spath.__file__', '/path/to/ipython/module.py'):
                    result = get_spath()
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/path/_get_spath.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/path/_get_spath.py
# --------------------------------------------------------------------------------
