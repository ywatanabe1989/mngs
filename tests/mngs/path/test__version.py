...
# File: ./tests/mngs/path/test__version.py
...
def test_find_latest_no_files():
    ...
    from mngs.path._version import find_latest
...
def test_increment_version_duplicate_function():
    ...
    from mngs.path._version import increment_version
    from mngs.path._increment_version import increment_version as increment_version_main
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/path/_version.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/path/_version.py
# --------------------------------------------------------------------------------
