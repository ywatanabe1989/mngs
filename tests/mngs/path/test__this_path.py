...
# File: ./tests/mngs/path/test__this_path.py
...
def test_this_path_normal():
    ...
    from mngs.path._this_path import this_path
    ...
    with patch('inspect.stack') as mock_stack:
        ...
        with patch('mngs.path._this_path.__file__', '/path/to/module.py'):
            result = this_path()
...
def test_this_path_ipython():
    ...
    with patch('inspect.stack') as mock_stack:
        ...
        with patch('mngs.path._this_path.__file__', '/path/to/ipython/module.py'):
            result = this_path()
...
def test_this_path_stack_levels():
    ...
    with patch('inspect.stack') as mock_stack:
        ...
        with patch('mngs.path._this_path.__file__', '/module/path.py'):
...
def test_get_this_path_alias():
    ...
    from mngs.path._this_path import this_path, get_this_path
...
def test_this_path_no_arguments():
    ...
    with patch('inspect.stack') as mock_stack:
        ...
        with patch('mngs.path._this_path.__file__', '/module.py'):
...
def test_this_path_absolute_path():
    ...
    with patch('inspect.stack') as mock_stack:
        ...
        with patch('mngs.path._this_path.__file__', '/absolute/path/to/module.py'):
            result = this_path()
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/path/_this_path.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/path/_this_path.py
# --------------------------------------------------------------------------------
