...
# File: ./tests/mngs/db/_SQLite3Mixins/test__IndexMixin.py
...
class TestIndexMixin:
    ...
    def test_create_index_basic(self):
        ...
        from mngs.db._SQLite3Mixins._IndexMixin import _IndexMixin
...
<<<<<<< HEAD
    main()\n\n# --------------------------------------------------------------------------------\n# Start of Source Code from: /home/ywatanabe/proj/_mngs_repo/src/mngs/db/_SQLite3Mixins/_IndexMixin.py
=======
    import os
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/db/_SQLite3Mixins/_IndexMixin.py
>>>>>>> origin/main
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/db/_SQLite3Mixins/_IndexMixin.py
# --------------------------------------------------------------------------------
