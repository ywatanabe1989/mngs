...
# File: ./tests/mngs/db/_SQLite3Mixins/test__ImportExportMixin.py
...
class TestImportExportMixin:
    ...
    def test_export_to_csv(self):
        ...
        from mngs.db._SQLite3Mixins._ImportExportMixin import _ImportExportMixin
...
<<<<<<< HEAD
    main()\n\n# --------------------------------------------------------------------------------\n# Start of Source Code from: /home/ywatanabe/proj/_mngs_repo/src/mngs/db/_SQLite3Mixins/_ImportExportMixin.py
=======
    import os
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/db/_SQLite3Mixins/_ImportExportMixin.py
>>>>>>> origin/main
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/db/_SQLite3Mixins/_ImportExportMixin.py
# --------------------------------------------------------------------------------
