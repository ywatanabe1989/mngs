...
# File: ./mngs_repo/tests/mngs/db/_PostgreSQLMixins/test__MaintenanceMixin_comprehensive.py
...
class MockMaintenanceMixin:
    ...
    def __init__(self):
        from mngs.db._PostgreSQLMixins._MaintenanceMixin import _MaintenanceMixin
