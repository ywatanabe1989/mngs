...
# File: tests/mngs/db/_PostgreSQLMixins/test__ImportExportMixin.py
...
from mngs.db._PostgreSQLMixins._ImportExportMixin import _ImportExportMixin
...
# --------------------------------------------------------------------------------
<<<<<<< HEAD
# End of Source Code from: /home/ywatanabe/proj/_mngs_repo/src/mngs/db/_PostgreSQLMixins/_ImportExportMixin.py
# --------------------------------------------------------------------------------
=======
