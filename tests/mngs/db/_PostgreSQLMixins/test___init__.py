...
# Path: /home/ywatanabe/proj/mngs_dev/tests/mngs/db/_PostgreSQLMixins/test___init__.py
# Reference: /home/ywatanabe/proj/mngs_dev/tests/_test_template.py

"""Tests for mngs.db._PostgreSQLMixins.__init__ module."""
...
class TestPostgreSQLMixinsInit:
    ...
    def test_imports_all_mixins(self):
        ...
        with patch('os.listdir') as mock_listdir, \
            ...
            if 'mngs.db._PostgreSQLMixins' in sys.modules:
                del sys.modules['mngs.db._PostgreSQLMixins']
            
            from mngs.db import _PostgreSQLMixins
    ...
    def test_skips_non_python_files(self):
        ...
        with patch('os.listdir') as mock_listdir, \
            ...
            mock_import.assert_any_call('._TestMixin', package='mngs.db._PostgreSQLMixins')
    ...
    def test_skips_private_attributes(self):
        ...
        with patch('os.listdir') as mock_listdir, \
            ...
            import mngs.db._PostgreSQLMixins as pg_mixins
    ...
    def test_module_structure(self):
        ...
        assert pg_mixins.__name__ == 'mngs.db._PostgreSQLMixins'

    def test_reimport_consistency(self):
        """Test that reimporting the module yields consistent results."""
        # First import
        import mngs.db._PostgreSQLMixins as pg_mixins1
        ...
        # Second import
        import mngs.db._PostgreSQLMixins as pg_mixins2
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/db/_PostgreSQLMixins/__init__.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/db/_PostgreSQLMixins/__init__.py
# --------------------------------------------------------------------------------
>>>>>>> origin/main
