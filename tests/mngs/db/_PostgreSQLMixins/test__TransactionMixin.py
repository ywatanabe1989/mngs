...
# Path: /home/ywatanabe/proj/mngs_dev/tests/mngs/db/_PostgreSQLMixins/test__TransactionMixin.py
# Reference: /home/ywatanabe/proj/mngs_dev/tests/_test_template.py

"""Tests for mngs.db._PostgreSQLMixins._TransactionMixin module."""

import pytest
from unittest.mock import MagicMock, patch, call
import psycopg2
from mngs.db._PostgreSQLMixins._TransactionMixin import _TransactionMixin
...
class TestTransactionMixin:
    ...
    def test_inheritance_from_base_mixin(self):
        ...
        from mngs.db._BaseMixins._BaseTransactionMixin import _BaseTransactionMixin
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/db/_PostgreSQLMixins/_TransactionMixin.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# # EOF
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/db/_PostgreSQLMixins/_TransactionMixin.py
# --------------------------------------------------------------------------------
>>>>>>> origin/main
