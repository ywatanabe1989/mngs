...
# File: tests/mngs/db/_PostgreSQLMixins/test__BackupMixin.py
...
from mngs.db._PostgreSQLMixins._BackupMixin import _BackupMixin
...
# --------------------------------------------------------------------------------
<<<<<<< HEAD
# End of Source Code from: /home/ywatanabe/proj/_mngs_repo/src/mngs/db/_PostgreSQLMixins/_BackupMixin.py
# --------------------------------------------------------------------------------
=======
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/db/_PostgreSQLMixins/_BackupMixin.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# 
#     def copy_table(self, source_table: str, target_table: str, where: Optional[str] = None) -> None:
...
#         self.execute(f"CREATE TABLE IF NOT EXISTS {target_table} AS SELECT * FROM {source_table} WHERE 1=0")
# 
#         # Copy data
...
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/db/_PostgreSQLMixins/_BackupMixin.py
# --------------------------------------------------------------------------------
>>>>>>> origin/main
