...
# File: tests/mngs/db/_PostgreSQLMixins/test__ConnectionMixin.py
...
import psycopg2
from mngs.db._PostgreSQLMixins._ConnectionMixin import _ConnectionMixin
...
class TestPostgreSQLConnectionMixin:
    ...
    def mock_psycopg2(self):
        ...
        with patch('mngs.db._PostgreSQLMixins._ConnectionMixin.psycopg2') as mock:
            mock_conn = MagicMock()
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/db/_PostgreSQLMixins/_ConnectionMixin.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# # EOF
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/db/_PostgreSQLMixins/_ConnectionMixin.py
# --------------------------------------------------------------------------------
