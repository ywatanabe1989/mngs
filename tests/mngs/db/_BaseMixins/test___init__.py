...
# File: ./tests/mngs/db/_BaseMixins/test___init__.py
...
def test_basemixins_module_structure():
    ...
    # Import the module
    import mngs.db._BaseMixins as basemixins_module
...
def test_basemixins_can_import_individual_mixins():
    ...
    from mngs.db._BaseMixins._BaseConnectionMixin import _BaseConnectionMixin
    from mngs.db._BaseMixins._BaseQueryMixin import _BaseQueryMixin
    from mngs.db._BaseMixins._BaseTableMixin import _BaseTableMixin
...
def test_base_mixin_classes_functionality():
    ...
    from mngs.db._BaseMixins._BaseConnectionMixin import _BaseConnectionMixin
    from mngs.db._BaseMixins._BaseBatchMixin import _BaseBatchMixin
...
def test_all_mixins_importable():
    ...
    mixin_modules = [
        'mngs.db._BaseMixins._BaseBackupMixin',
        'mngs.db._BaseMixins._BaseBatchMixin',
        'mngs.db._BaseMixins._BaseBlobMixin', 
        'mngs.db._BaseMixins._BaseConnectionMixin',
        'mngs.db._BaseMixins._BaseImportExportMixin',
        'mngs.db._BaseMixins._BaseIndexMixin',
        'mngs.db._BaseMixins._BaseMaintenanceMixin',
        'mngs.db._BaseMixins._BaseQueryMixin',
        'mngs.db._BaseMixins._BaseRowMixin',
        'mngs.db._BaseMixins._BaseSchemaMixin',
        'mngs.db._BaseMixins._BaseTableMixin',
        'mngs.db._BaseMixins._BaseTransactionMixin'
    ]
...
def test_mixin_module_file_attributes():
    ...
    from mngs.db._BaseMixins import _BaseConnectionMixin
