...
# File: ./mngs_repo/tests/mngs/life/test__monitor_rain.py
...
class TestMonitorRain:
    ...
    def test_module_import(self):
        ...
        from mngs.life import _monitor_rain
    ...
    @patch('requests.get')
    @patch('mngs.life._monitor_rain.notify_rain')
    ...
    @patch('time.sleep')
    @patch('mngs.life._monitor_rain.check_rain')
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/life/_monitor_rain.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/life/_monitor_rain.py
# --------------------------------------------------------------------------------
>>>>>>> origin/main
