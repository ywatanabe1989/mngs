...
# /data/gpfs/projects/punim2354/ywatanabe/.claude-worktree/mngs_repo/tests/mngs/nn/test__SpatialAttention.py
...
import numpy as np
from mngs.nn._SpatialAttention import SpatialAttention
...
class TestSpatialAttentionArchitecture:
    ...
    def test_adaptive_avg_pool_initialization(self):
        ...
        assert module.aap.output_size == (1,)
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /home/ywatanabe/proj/_mngs_repo/src/mngs/nn/_SpatialAttention.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: /home/ywatanabe/proj/_mngs_repo/src/mngs/nn/_SpatialAttention.py
# --------------------------------------------------------------------------------
