...
class TestBaseFilter1D:
    ...
    def test_base_filter_initialization(self):
        ...
        from mngs.nn._Filters import BaseFilter1D
...
class TestBandPassFilter:
    ...
    def test_bandpass_initialization(self):
        ...
        from mngs.nn._Filters import BandPassFilter
        
        bands = torch.tensor([[10, 20], [20, 40], [40, 80]])
        fs = 256
        seq_len = 1024
        
        with patch('mngs.nn._Filters.design_filter') as mock_design:
...
class TestBandStopFilter:
    ...
    def test_bandstop_initialization(self):
        ...
        from mngs.nn._Filters import BandStopFilter
...
class TestLowPassFilter:
    ...
    def test_lowpass_initialization(self):
        ...
        from mngs.nn._Filters import LowPassFilter
...
class TestHighPassFilter:
    ...
    def test_highpass_initialization(self):
        ...
        from mngs.nn._Filters import HighPassFilter
...
class TestGaussianFilter:
    ...
    def test_gaussian_initialization(self):
        ...
        from mngs.nn._Filters import GaussianFilter
        
        sigma = 5
        
        with patch('mngs.gen._to_even.to_even') as mock_to_even:
...
class TestDifferentiableBandPassFilter:
    ...
    def test_differentiable_initialization(self):
        ...
        from mngs.nn._Filters import DifferentiableBandPassFilter
        
        sig_len = 512
        fs = 256
        
        with patch('mngs.nn._Filters.init_bandpass_filters') as mock_init:
    ...
    def test_differentiable_forward_pass(self):
        ...
        with patch('mngs.nn._Filters.init_bandpass_filters') as mock_init:
            with patch('mngs.nn._Filters.build_bandpass_filters') as mock_build:
                # Setup mocks
                n_total_bands = 20
...
class TestMultiFilterProcessing:
    ...
    def test_cascade_filtering(self):
        ...
        from mngs.nn._Filters import HighPassFilter, LowPassFilter
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/nn/_Filters.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# # EOF
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/nn/_Filters.py
# --------------------------------------------------------------------------------
>>>>>>> origin/main
