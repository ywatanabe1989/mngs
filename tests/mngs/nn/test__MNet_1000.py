...
# /data/gpfs/projects/punim2354/ywatanabe/.claude-worktree/mngs_repo/tests/mngs/nn/test__MNet_1000.py
...
import numpy as np
from mngs.nn._MNet_1000 import MNet1000, MNet_1000, SwapLayer, ReshapeLayer, MNet_config
...
class TestMNet1000ForwardPass:
    ...
    def test_reshape_input_static_method(self):
        ...
        assert reshaped.shape == (BS, 1, N_CHS, SEQ_LEN, 1)
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/nn/_MNet_1000.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/nn/_MNet_1000.py
# --------------------------------------------------------------------------------
