...
from mngs.nn._SwapChannels import SwapChannels
...
class TestSwapChannels:
    ...
    def test_dropout_rate_one(self):
        ...
        # All channels should be swapped
        channels_same = 0
        for ch in range(10):
            if torch.allclose(x[:, ch, :], output[:, ch, :]):
                channels_same += 1
                
        assert channels_same == 0  # All channels should be swapped
    ...
    def test_partial_channel_swapping(self):
        ...
        for _ in range(n_trials):
            ...
            torch.manual_seed(None)  # Random seed
            output = layer(x)
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/nn/_SwapChannels.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/nn/_SwapChannels.py
# --------------------------------------------------------------------------------
