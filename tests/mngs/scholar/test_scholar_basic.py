...
"""
Basic tests for the MNGS Scholar module.
"""
...
class TestScholarBasic:
    ...
    def test_import(self):
        ...
        assert hasattr(mngs.scholar, 'search')
        assert hasattr(mngs.scholar, 'search_sync')
        assert hasattr(mngs.scholar, 'build_index')
        assert hasattr(mngs.scholar, 'Paper')
        assert hasattr(mngs.scholar, 'get_scholar_dir')
    
    def test_paper_creation(self):
        """Test Paper object creation."""
        paper = mngs.scholar.Paper(
            title="Test Paper",
    ...
    def test_scholar_dir(self):
        ...
        scholar_dir = mngs.scholar.get_scholar_dir()
    ...
    def test_vector_search_engine(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            engine = mngs.scholar.VectorSearchEngine(
            ...
            engine2 = mngs.scholar.VectorSearchEngine(
                index_path=Path(tmpdir) / "test_index.pkl"
            )
            engine2.load_index()
    ...
    def test_local_search_engine(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            engine = mngs.scholar.LocalSearchEngine(
    ...
    async def test_pdf_downloader(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            downloader = mngs.scholar.PDFDownloader(
    ...
    def test_build_index_basic(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            import os
            original_env = os.environ.get('MNGS_SCHOLAR_DIR')
            os.environ['MNGS_SCHOLAR_DIR'] = tmpdir
            ...
            try:
                ...
                if original_env:
                    os.environ['MNGS_SCHOLAR_DIR'] = original_env
                else:
                    os.environ.pop('MNGS_SCHOLAR_DIR', None)
