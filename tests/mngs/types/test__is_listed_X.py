...
# File: ./tests/mngs/types/test__is_listed_X.py
# ----------------------------------------

"""
Comprehensive test suite for mngs.types._is_listed_X module.
...
import pytest
import numpy as np
from src.mngs.types._is_listed_X import is_listed_X
