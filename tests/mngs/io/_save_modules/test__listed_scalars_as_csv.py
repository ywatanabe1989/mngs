...
"""Tests for the _save_listed_scalars_as_csv function in mngs.io module."""
...
class TestSaveListedScalarsBasic:
    ...
    def test_save_simple_scalars(self, tmp_path):
        ...
        from mngs.io._save_listed_scalars_as_csv import _save_listed_scalars_as_csv
...
class TestSaveListedScalarsOptions:
    ...
    def test_overwrite_true(self, tmp_path):
        ...
        with patch("mngs.io._save_listed_scalars_as_csv._mv_to_tmp") as mock_mv:
...
<<<<<<< HEAD:tests/mngs/io/test__save_listed_scalars_as_csv.py
=======

# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/io/_save_listed_scalars_as_csv.py
# --------------------------------------------------------------------------------
>>>>>>> origin/main:tests/mngs/io/_save_modules/test__listed_scalars_as_csv.py
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
