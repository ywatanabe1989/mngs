...
# File: ./mngs_repo/tests/mngs/io/_load_modules/test__db.py
...
class TestLoadSQLite3DB:
    ...
    def test_valid_extension_check(self):
        ...
        from mngs.io._load_modules._db import _load_sqlite3db
    ...
    @patch('mngs.io._load_modules._db.SQLite3')
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/io/_load_modules/_db.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/io/_load_modules/_db.py
# --------------------------------------------------------------------------------
>>>>>>> origin/main
