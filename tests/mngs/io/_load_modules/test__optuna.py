...
# File: ./mngs_repo/tests/mngs/io/_load_modules/test__optuna.py
...
class TestLoadOptunaFunctions:
    ...
    @patch('mngs.io._load_modules._optuna.load')
    def test_load_yaml_as_optuna_dict_categorical(self, mock_load):
        ...
        from mngs.io._load_modules._optuna import load_yaml_as_an_optuna_dict
    ...
    @patch('mngs.io._load_modules._optuna.optuna')
    def test_load_study_rdb_basic(self, mock_optuna):
        """Test loading Optuna study from RDB storage"""
        from mngs.io._load_modules._optuna import load_study_rdb
    ...
    def test_function_signatures(self):
        ...
        from mngs.io._load_modules._optuna import load_yaml_as_an_optuna_dict, load_study_rdb
        import inspect
    ...
    def test_real_world_ml_hyperparameter_scenario(self):
        ...
        try:
            ...
            with patch('mngs.io._load_modules._optuna.load') as mock_load:
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/io/_load_modules/_optuna.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/io/_load_modules/_optuna.py
# --------------------------------------------------------------------------------
>>>>>>> origin/main
