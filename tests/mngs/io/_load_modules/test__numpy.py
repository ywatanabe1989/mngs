...
# File: ./mngs_repo/tests/mngs/io/_load_modules/test__numpy.py

"""Tests for NumPy file loading functionality.

This module tests the _load_npy function and its helpers from mngs.io._load_modules._numpy,
...
def test_load_npy_basic():
    ...
    from mngs.io._load_modules._numpy import _load_npy
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/io/_load_modules/_numpy.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/io/_load_modules/_numpy.py
# --------------------------------------------------------------------------------
>>>>>>> origin/main
