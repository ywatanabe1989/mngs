...
# File: ./mngs_repo/tests/mngs/io/_load_modules/test__joblib_comprehensive.py
...
class TestLoadJoblibIntegration:
    """Integration tests with other mngs.io functionality."""
    
    @patch('mngs.io._load_modules._joblib.joblib.load')
