...
# File: ./mngs_repo/tests/mngs/io/_load_modules/test__pandas.py

"""Tests for pandas file loading functionality.

This module tests the pandas loading functions from mngs.io._load_modules._pandas,
...
def test_load_csv_basic():
    ...
    from mngs.io._load_modules._pandas import _load_csv
...
def test_load_tsv_basic():
    ...
    from mngs.io._load_modules._pandas import _load_tsv
...
def test_load_excel_basic():
    ...
    from mngs.io._load_modules._pandas import _load_excel
...
def test_load_parquet_basic():
    ...
    from mngs.io._load_modules._pandas import _load_parquet
