...
# File: ./mngs_repo/tests/mngs/io/_load_modules/test__txt.py

"""Tests for text file loading functionality.

This module tests the _load_txt function from mngs.io._load_modules._txt,
...
def test_load_txt_basic():
    ...
    from mngs.io._load_modules._txt import _load_txt
