...
# File: ./mngs_repo/tests/mngs/io/_load_modules/test__catboost.py
...
class TestLoadCatBoost:
    ...
    def mock_catboost_available(self):
        ...
        with patch('mngs.io._load_modules._catboost.CATBOOST_AVAILABLE', True):
            yield

    @pytest.fixture
    def mock_catboost_unavailable(self):
        """Mock CatBoost unavailability."""
        with patch('mngs.io._load_modules._catboost.CATBOOST_AVAILABLE', False):
            yield
    ...
    def test_import_error_when_catboost_unavailable(self, mock_catboost_unavailable):
        ...
        from mngs.io._load_modules._catboost import _load_catboost
    ...
    def test_classifier_loading_success(self, mock_catboost_available):
        ...
        import mngs.io._load_modules._catboost as catboost_module
    ...
    def test_integration_with_main_load_function(self):
        ...
        try:
            ...
            try:
                ...
                loaded_model = mngs.io.load(temp_path)
