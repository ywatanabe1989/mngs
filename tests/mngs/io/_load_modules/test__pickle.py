...
# File: ./mngs_repo/tests/mngs/io/_load_modules/test__pickle.py

"""Tests for pickle file loading functionality.

This module tests the _load_pickle function from mngs.io._load_modules._pickle,
...
def test_load_pickle_basic():
    ...
    from mngs.io._load_modules._pickle import _load_pickle
