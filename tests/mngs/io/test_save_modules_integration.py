...
# File: /ssh:sp:/home/ywatanabe/proj/.claude-worktree/mngs_repo/tests/mngs/io/test_save_modules_integration.py
# ----------------------------------------
import os

__FILE__ = "./tests/mngs/io/test_save_modules_integration.py"
__DIR__ = os.path.dirname(__FILE__)
# ----------------------------------------

"""
Integration tests for mngs.io save modules.
...
class TestSaveModulesIntegration:
    ...
    def test_save_listed_dfs_functionality(self, temp_dir):
        ...
        # Save using mngs.io.save
        mngs.io.save(listed_dfs, csv_path)
    ...
    def test_save_numpy_arrays(self, temp_dir):
        ...
        mngs.io.save({'array': arr}, npz_path)
    ...
    def test_save_dict_json(self, temp_dir):
        ...
        # Save
        mngs.io.save(test_dict, json_path)
    ...
    def test_save_text_content(self, temp_dir):
        ...
        # Save
        mngs.io.save(text_content, txt_path)
