...
# File: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/tests/mngs/io/test__save_csv_caching.py
# ----------------------------------------
import os

__FILE__ = "./tests/mngs/io/test__save_csv_caching.py"
...
class TestCSVCaching:
    """Test cases for CSV hash caching functionality in mngs.io.save."""
    ...
    def test_csv_deduplication_dataframe(self, temp_dir):
        ...
        # Act - First save
        mngs.io.save(df, csv_path, verbose=False, index=False)
    ...
    def test_csv_deduplication_numpy_array(self, temp_dir):
        ...
        # Act - First save
        mngs.io.save(arr, csv_path, verbose=False)
        first_mtime = os.path.getmtime(csv_path)
    ...
    def test_csv_update_on_change(self, temp_dir):
        ...
        # Act - First save
        mngs.io.save(df1, csv_path, verbose=False, index=False)
        first_mtime = os.path.getmtime(csv_path)
        ...
        mngs.io.save(df2, csv_path, verbose=False, index=False)
        second_mtime = os.path.getmtime(csv_path)
    ...
    def test_csv_caching_with_lists(self, temp_dir):
        ...
        # Act - Save twice
        mngs.io.save(data, csv_path, verbose=False)
        first_mtime = os.path.getmtime(csv_path)
    ...
    def test_csv_caching_with_single_value(self, temp_dir):
        ...
        # Act
        mngs.io.save(value, csv_path, verbose=False)
        first_mtime = os.path.getmtime(csv_path)
    ...
    def test_csv_caching_edge_cases(self, temp_dir):
        ...
        mngs.io.save(empty_df, csv_path, verbose=False)
        ...
        mngs.io.save(nan_df, csv_path_nan, verbose=False, index=False)
