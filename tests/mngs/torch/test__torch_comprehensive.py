...
# File: ./tests/mngs/torch/test__torch_comprehensive.py

"""
Comprehensive tests for mngs.torch module to improve test coverage.
...
class TestTorchModuleIntegration:
    ...
    def test_module_imports(self):
        ...
        for func_name in nan_functions:
            assert hasattr(mngs.torch, func_name)

    def test_combined_usage(self):
        """Test using apply_to with nan functions."""
        from mngs.torch import apply_to, nanmax
    ...
    def test_device_agnostic(self):
        ...
        from mngs.torch import nanmax, apply_to
    ...
    def test_performance_characteristics(self):
        ...
        from mngs.torch import nanmax, nanmin
        import time
...
class TestTorchUtilityFunctions:
    ...
    def test_type_preservation(self):
        ...
        from mngs.torch import nanmax, nancumprod
    ...
    def test_gradient_flow(self):
        ...
        from mngs.torch import nanvar, nanstd
