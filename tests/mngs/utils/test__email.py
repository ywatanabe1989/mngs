...
# File: ./tests/mngs/utils/test__email.py
...
from mngs.utils._email import send_gmail, ansi_escape
...
class TestEmailFunctionality:
    ...
    @patch('mngs.utils._email.smtplib.SMTP')
    ...
    @patch('mngs.utils._email.smtplib.SMTP')
    @patch('mngs.utils._email.gen_ID')
...
# --------------------------------------------------------------------------------
# Start of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/utils/_email.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
...
# --------------------------------------------------------------------------------
# End of Source Code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/utils/_email.py
# --------------------------------------------------------------------------------
>>>>>>> origin/main
