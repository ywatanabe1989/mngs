#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Test for mngs.plt.close() function
...
def test_close_no_args():
    """Test mngs.plt.close() without arguments."""
    print("Testing mngs.plt.close() without arguments...")
...
def test_close_with_arg():
    """Test mngs.plt.close() with a specific figure argument."""
    print("\nTesting mngs.plt.close() with a specific figure argument...")
...
def test_close_all_string():
    """Test mngs.plt.close('all')."""
    print("\nTesting mngs.plt.close('all')...")
