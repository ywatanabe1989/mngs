...
# Save figure and CSV
mngs.io.save(fig, f"{output_dir}/single_axis.png")
...
# Save figure and CSV
mngs.io.save(fig, f"{output_dir}/multiple_axes_grid.png")
csv_df = fig.export_as_csv()
...
# Save figure and CSV
mngs.io.save(fig, f"{output_dir}/three_different_plots.png")
csv_df = fig.export_as_csv()
