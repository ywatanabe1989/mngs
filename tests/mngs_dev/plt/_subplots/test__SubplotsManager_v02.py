# --------------------------------------------------------------------------------
# Start of Source code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/plt/_subplots/_SubplotsManager_v02.py
# --------------------------------------------------------------------------------
# #!/usr/bin/env python3
# # -*- coding: utf-8 -*-
# # Timestamp: "2025-04-27 12:08:09 (ywatanabe)"
...
#         axes_orig_shape = axes_array.shape
# 
#         if axes_orig_shape == (1,):
#             self.ax_wrapper = AxisWrapper(
#                 self.fig_wrapper, axes_array[0], track
#             )
#             self.fig_wrapper.axes = np.array([self.ax_wrapper])
#             return self.fig_wrapper, self.ax_wrapper
#         else:
#             axes_flat = axes_array.ravel()
#             wrapped_list = [
#                 AxisWrapper(self.fig_wrapper, axis_, track)
#                 for axis_ in axes_flat
#             ]
#             reshaped = np.array(wrapped_list).reshape(axes_orig_shape)
...
#             return orig
#         warnings.warn(
#             f"MNGS SubplotsManager: '{name}' not found on wrapper or figure, call ignored.",
#             UserWarning,
#         )
# 
...
# # EOF#
# --------------------------------------------------------------------------------
# End of Source code from: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/plt/_subplots/_SubplotsManager_v02.py
# --------------------------------------------------------------------------------
