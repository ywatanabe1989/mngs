...
Your docs will be available at: `https://[username].github.io/mngs/`
...
4. Your docs will be at: `https://mngs.readthedocs.io/`
...
cp -r _build/html/* /path/to/shared/docs/mngs/
```
