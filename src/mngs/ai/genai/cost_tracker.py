...
# Author: ywatanabe
# File: ./src/mngs/ai/genai/cost_tracker.py
...
class CostTracker:
    ...
    def get_detailed_report(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "average_per_call": {
                "input_tokens": self.input_tokens / len(self._history) if self._history else 0,
                "output_tokens": self.output_tokens / len(self._history) if self._history else 0,
            }
        }
