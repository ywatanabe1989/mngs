...
# File: ./mngs_repo/src/mngs/ai/genai/llama_provider.py
...
class LlamaProvider(BaseProvider):
    ...
    def __init__(self, config: ProviderConfig):
        ...
        self.tokenizer_path = getattr(config, 'tokenizer_path', None) or f"{self.model_name}/tokenizer.model"
    ...
    def complete(self, messages: List[Dict[str, Any]], **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            prompt_tokens = len(" ".join(msg["content"] for msg in formatted_messages).split())
