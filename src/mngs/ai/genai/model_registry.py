...
# Author: ywatanabe
# File: ./src/mngs/ai/genai/model_registry.py
...
class ModelRegistry:
    ...
    def _build_cache(self) -> None:
        ...
        for _, row in self._models_df.iterrows():
            ...
            cost_input = row.get('cost_1k_input_tokens', row.get('cost_per_1k_input', 0.0))
            cost_output = row.get('cost_1k_output_tokens', row.get('cost_per_1k_output', 0.0))
