...
"""
Unified search interface for MNGS Scholar.
"""
...
def get_scholar_dir() -> Path:
    """Get the MNGS Scholar directory from environment or default."""
    scholar_dir = os.environ.get('MNGS_SCHOLAR_DIR', '~/.mngs/scholar')
