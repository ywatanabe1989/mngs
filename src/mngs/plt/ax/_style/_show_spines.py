...
# File: ./src/mngs/plt/ax/_style/_show_spines.py
...
def show_spines(
    ...
    you have spines hidden by default (as in mngs configuration) and want to selectively show them
    ...
    Notes
    -----
    This function is designed to work seamlessly with mngs plotting where spines are hidden
    ...
    """
    # Handle both matplotlib axes and mngs AxisWrapper
    if hasattr(axis, '_axis_mpl'):
        # This is an mngs AxisWrapper, get the underlying matplotlib axis
        axis = axis._axis_mpl
    
    assert isinstance(
        axis, matplotlib.axes._axes.Axes
    ), "First argument must be a matplotlib axis or mngs AxisWrapper"
