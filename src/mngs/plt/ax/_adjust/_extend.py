#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Timestamp: "2025-04-30 20:30:16 (ywatanabe)"
# File: /home/ywatanabe/proj/mngs_repo/src/mngs/plt/ax/_extend.py
# ----------------------------------------
import os
__FILE__ = (
...
def extend(axis, x_ratio=1.0, y_ratio=1.0):
    ...
    Args:
        axis (matplotlib.axises._axises.Axises): The matplotlib axis to be modified.
    ...
    Returns:
        matplotlib.axises._axises.Axises: The modified matplotlib axis.
