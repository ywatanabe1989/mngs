...
import matplotlib
from mngs.plt.utils import assert_valid_axis
...
def plot_image(
    ...
    **kwargs,
    ...
    Parameters
    ----------
    ax : matplotlib.axes.Axes or mngs.plt._subplots._AxisWrapper.AxisWrapper
        The axis to plot on
    ...
    **kwargs
    ...
    Returns
    -------
    matplotlib.axes.Axes or mngs.plt._subplots._AxisWrapper.AxisWrapper
