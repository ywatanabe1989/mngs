#!/usr/bin/env python3
# -*- coding: utf-8 -*-
# Timestamp: "2025-04-29 10:11:47 (ywatanabe)"
# File: /home/ywatanabe/proj/mngs_repo/src/mngs/plt/__subplots_not_compatible/_SubplotsManager.py
# ----------------------------------------
import os
__FILE__ = (
    "./src/mngs/plt/__subplots_not_compatible/_SubplotsManager.py"
)
