...
# File: /ssh:ywatanabe@sp:/home/ywatanabe/proj/.claude-worktree/mngs_repo/src/mngs/plt/_subplots/_AxisWrapperMixins/_AdjustmentMixin.py
# ----------------------------------------
import os
__FILE__ = (
...
class AdjustmentMixin:
    ...
    def set_xytc(
        ...
        t : str, optional
            Title
        c : str, optional
            Caption to be saved automatically with mngs.io.save()
    ...
    def set_supxytc(
        ...
        caption : str, optional
            Figure-level caption to be saved automatically with mngs.io.save()
        format_labels : bool, optional
            Whether to apply automatic formatting, by default True
        """
