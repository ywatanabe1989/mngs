#!./env/bin/python3
# -*- coding: utf-8 -*-
# Time-stamp: "2024-06-05 00:44:18 (ywatanabe)"
...
def interp_colors(color_start, color_end, num_points):
    ...
    rgba_values = np.linspace(color_start_rgba, color_end_rgba, num_points)
