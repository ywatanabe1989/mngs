...
# File: ./src/mngs/plt/utils/_scientific_captions.py
...
# Integration with mngs save system
...
def _save_caption_multiple_formats(
    ...
    """
    Save caption in multiple formats (like how mngs saves CSV data).
    ...
    # Save files (following mngs naming convention)
    if save_txt:
...
# Enhanced integration with mngs.io.save
def enhance_mngs_save_with_captions():
    """
    Enhance the mngs.io.save system to automatically handle captions.
    
    This can be called to monkey-patch mngs.io.save to include caption support.
    """
    import mngs
    
    # Store original save function
    original_save = mngs.io.save
    ...
    mngs.io.save = enhanced_save
    print("📝 mngs.io.save enhanced with caption support!")
    print("Usage: mngs.io.save(fig, 'filename.png', caption='Your caption here')")
...
def _create_latex_figure_list(output_file: str):
    ...
    with open(output_file, 'w', encoding='utf-8') as f:
        f.write("% Figure List - Generated by mngs\n")
...
def _create_markdown_figure_list(output_file: str):
    ...
    with open(output_file, 'w', encoding='utf-8') as f:
        f.write("# Figure List\n\n")
        f.write("*Generated by mngs scientific caption system*\n\n")
