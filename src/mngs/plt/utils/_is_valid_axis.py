...
# File: /data/gpfs/projects/punim2354/ywatanabe/mngs_repo/src/mngs/plt/utils/_is_valid_axis.py
# ----------------------------------------
import os
__FILE__ = (
    "./src/mngs/plt/utils/_is_valid_axis.py"
)
...
def assert_valid_axis(axis, error_message=None):
    """
    Assert that the provided object is a valid axis (matplotlib Axes or mngs AxisWrapper).
