...
# File: ./mngs_repo/src/mngs/decorators/_auto_order.py
...
def enable_auto_order():
    """
    Enable auto-ordering for all decorators in the mngs.decorators module.
    ...
    ...     return x.mean()
    """
    import mngs.decorators as decorators_module
    ...
    print("Auto-ordering enabled for mngs decorators!")
