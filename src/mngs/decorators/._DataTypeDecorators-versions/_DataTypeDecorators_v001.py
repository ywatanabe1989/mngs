...
3. Output:
   - Processed data with input type (regardless of the decorators) and batch handling; For example, if input arrays are numpy/pandas/torch/pandas, the output arrays are numpy/pandas/torch/pandas, respectively.
4. Prerequisites:
